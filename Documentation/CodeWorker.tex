...
\makebox[0.4cm][l]{}getVariableName(...) file "c:/Projects/generator/Scripts/Tutorial/GettingStarted/SharedFunctions.cws" at 76: 26 occurences in 2ms\\
\makebox[0.4cm][l]{}normalizeIdentifier(...) file "c:/Projects/generator/Scripts/Tutorial/GettingStarted/SharedFunctions.cws" at 5: 39 occurences in 1ms\\
...
\index{preprocessor directives!if}
\index{\#if}
\index{\#else}
\index{\#end}
\pdfsubsubsection{Conditionally processing a part of the script}
The \samp{\textbf{\#include} [\textbf{!}]? \textit{predicat} ( \textit{parameters} )} announces the beginning
of some script lines that have to be processed by the interpreter only if a condition occurs.
This conditional area ends with the directive \samp{\textbf{\#end}}.
An alternative block of lines can be optionally specified inside the conditional area, starting
with the directive \samp{\textbf{\#else}}. It will be compiled only if the condition fails.

The condition is a predicat, or its negation if the \textbf{'!'} symbol preceeds the predicat.

Only one predicat is accepted for the moment:
\begin{itemize}
	\item \samp{\textbf{existFunction(} \textit{function-name} \textbf{)}}: the condition occurs if
		the function named \textit{function-name} already exists in the scope.
\end{itemize}

\textbf{Example:}\\
\texttt{
\textbf{\#if existFunction}(f)\\
function g() \{\\
	\makebox[0.4cm][r]{}return "result of f(): " + f();\\
\}\\
\#else\\
function f() \{\\
	\makebox[0.4cm][r]{}return "f() was missing: declare it now";\\
\}\\
\#end\\
}
...
\texttt{getNow() = '01may2010 20:42:00.500'\\
...
\texttt{Today date with reset time = '01may2010'\\
Today date (Excel-like) = '40299.862506'\\
Preceding day = '30apr2010 20:42:00.518'\\
15th of the current month = '15may2010'\\
august of this year = '01aug2010'\\
15/04 = '15apr2010'\\
...
\texttt{last access to 'Documentation/CodeWorker.tex' = 01may2010 17:43:08}
...
\texttt{last modification of 'Documentation/CodeWorker.tex' = 01may2010 06:39:54}
...
\texttt{size of 'Documentation/CodeWorker.tex' = 926201 characters}
...
\texttt{release of the documentation = '01may2010 20:42:00.500'\\
a new format = 'may 01, 2010'\\
the hour only = '20'}
...
generated text:\\
//\#\#generation header\#\#CodeWorker\#\#4.5.4\#\#01may2010 17:43:15\#\#"c:/Projects/generator/Scripts/Tutorial/GettingStarted/Tiny-JAVA.cwt"\#\#\\
//\#\#header start\#\#\\
//Popeye's Village\\
//Knights of Malta\\
//\#\#header end\#\#\\
...
creating node 'element 2'\\
creating node 'element 1'\\
time of execution = 0.00003787654232808957 seconds}
...
\texttt{now is '01may2010 20:42:00.500'}
...
\texttt{The version of the interpreter is '4.5.4'}
...
generated text:\\
//\#\#generation header\#\#CodeWorker\#\#4.5.4\#\#01may2010 17:43:16\#\#"c:/Projects/generator/Scripts/Tutorial/GettingStarted/Tiny-JAVA.cwt"\#\#\\
//\#\#header start\#\#\\
//Popeye's Village\\
//Olive hates spinash\\
//\#\#header end\#\#\\
...
\texttt{now = 01may2010 20:42:00.500\\
...
\texttt{The version of scripts is '4.5.4'\\
...
CodeWorker v4.5.4 (LGPL), parses and generates source code easily;\\
...
\texttt{generation of an UUID = '0e1a0233-fca1-49c2-ac2b-89787e0f65cd'\\
generation of another one = '96200880-fa1a-4379-8201-52070fe4e2d5'}
\end{itemize}
