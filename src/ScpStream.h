...
public:
    ...
    inline bool insertMode() const
    {
        return _bInsertText;
    }
    inline void insertMode(bool bInsertMode)
    {
        _bInsertText = bInsertMode;
    }
    inline ScpStream* getParentStream() const
    {
        return _pParentStream;
    }
    inline void setParentStream(ScpStream* pStream)
    {
    ...
    int readChar();
    int peekChar();
    inline int getInputLocation() const
    {
        return _iReadCursor;
    }
    ...
    inline int getOutputLocation() const
    {
    ...
    static void setListOfIncludePaths(const std::list<std::string>& listOfIncludePaths)
    {
