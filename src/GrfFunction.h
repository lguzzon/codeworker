...
public:
    ...
    inline unsigned int getArity() const
    {
    ...
    {
        return (_pTemplateFunction != NULL) || !_mapOfInstantiatedFunctions.empty() || (_pGenericTemplateFunction != NULL);
    }
    ...
    inline bool isGenericKey() const
    {
        return _bGenericKey;
    }
    inline GrfFunction* getTemplateFunction() const
    {
        return _pTemplateFunction;
    }
    inline const std::map<std::string, GrfFunction*>& getInstantiatedFunctions() const
    {
    ...
    inline bool isBodyDefined() const
    {
        return _bIsBodyDefined;
    }
    ...
    inline void isExternal(bool bIsExternal)
    {
        _bIsExternal = bIsExternal;
    }
    inline GrfBlock* getFinally() const
    {
        return _pFinally;
    }
    inline void setFinally(GrfBlock* pFinally)
    {
        _pFinally = pFinally;
    }
