...
#ifndef _BNFReadCChar_h_
#define _BNFReadCChar_h_
...
class BNFReadCChar : public GrfCommand
{
private:
...
public:
    BNFReadCChar(DtaBNFScript* pBNFScript, GrfBlock* pParent, bool bContinue, bool bNoCase);
    virtual ~BNFReadCChar();
