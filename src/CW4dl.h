 ...
 *												  CW4dl::Parameter
 *p1, CW4dl::Parameter p2); where 'selectList' is a function expecting 2
 *parameters.
 *
 ...
 *												  int
 *nbParams, CW4dl::Parameter* tParams); where 'tParams' is an array of parameter
 *types, and where 'nbParams' gives the size.
 *
 * The initializer 'XXX_Init' informs the engine about the existence
...
typedef const char* (*COPY_LOCAL_STRING)(Interpreter* pInterpreter,
                                         const char*);
...
public:
  ...
  inline bool createCommand(const char* tcName,
                            ...
                            PARAMETER_TYPE p2)
  {
    return _createCommand2(
      _pPackage, tcName, (p1 == NODE_PARAMETER), (p2 == NODE_PARAMETER));
  }
  inline bool createCommand(const char* tcName,
                            PARAMETER_TYPE p1,
                            PARAMETER_TYPE p2,
                            PARAMETER_TYPE p3)
  {
    return _createCommand3(_pPackage,
                           tcName,
                           (p1 == NODE_PARAMETER),
                           (p2 == NODE_PARAMETER),
                           (p3 == NODE_PARAMETER));
  ...
  inline bool createCommand(const char* tcName,
                            ...
                            PARAMETER_TYPE p4)
  {
    return _createCommand4(_pPackage,
                           tcName,
                           (p1 == NODE_PARAMETER),
                           (p2 == NODE_PARAMETER),
                           (p3 == NODE_PARAMETER),
   ...
   **/
  inline void setExternalValue(Tree* pTree,
                               CodeWorker::ExternalValueNode* pInstance)
  {
   ...
   **/
  inline Tree* insertItem(Tree* pArray,
                          const char* tcKey,
                          const char* tcValue = NULL)
  {
