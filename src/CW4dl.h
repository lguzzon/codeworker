...
public:
    inline Parameter2CW(const char* tcValue) : _bValue(true)
    {
        _param._tcValue = tcValue;
    }
    inline Parameter2CW(Tree* pNode) : _bValue(false)
    {
        _param._pNode = pNode;
    }
};
...
public:
     ...
     **/
    inline bool createCommand(const char* tcName)
    {
        return _createCommand0(_pPackage, tcName);
    }
    inline bool createCommand(const char* tcName, PARAMETER_TYPE p1)
    {
        return _createCommand1(_pPackage, tcName, (p1 == NODE_PARAMETER));
    }
    inline bool createCommand(const char* tcName, PARAMETER_TYPE p1, PARAMETER_TYPE p2)
    {
        return _createCommand2(_pPackage, tcName, (p1 == NODE_PARAMETER), (p2 == NODE_PARAMETER));
    }
    inline bool createCommand(const char* tcName, PARAMETER_TYPE p1, PARAMETER_TYPE p2, PARAMETER_TYPE p3)
    {
        return _createCommand3(_pPackage, tcName, (p1 == NODE_PARAMETER), (p2 == NODE_PARAMETER), (p3 == NODE_PARAMETER));
    }
    inline bool createCommand(const char* tcName, PARAMETER_TYPE p1, PARAMETER_TYPE p2, PARAMETER_TYPE p3, PARAMETER_TYPE p4)
    {
        return _createCommand4(_pPackage, tcName, (p1 == NODE_PARAMETER), (p2 == NODE_PARAMETER), (p3 == NODE_PARAMETER), (p4 == NODE_PARAMETER));
    }
    inline bool createCommand(const char* tcName, int iNbParams, PARAMETER_TYPE* tParams)
    {
        return _createCommandN(_pPackage, tcName, iNbParams, (int*) tParams);
    }

    inline Tree* createVariable(const char* tcName)
    {
        return _createVariable(_pPackage, tcName);
    }
    ...
    {
        return _copyLocalString(this, tcText);
    }
    inline const char* copyLocalBoolean(bool bValue)
    {
        return _copyLocalBoolean(this, bValue);
    }
    inline const char* copyLocalInt(int iValue)
    {
        return _copyLocalInt(this, iValue);
    }
    inline const char* copyLocalDouble(double dValue)
    {
        return _copyLocalDouble(this, dValue);
    }
     ...
     * scripting language.
     **/
    inline void error(const char* tcError)
    {
        _error(tcError);
    }
     ...
     **/
    inline static const char* trueConstant()
    {
        return "true";
    }
     ...
     * use.
     **/
    inline Tree* createTree(const char* tcName)
    {
        return _createTree(tcName);
    }
     ...
     **/
    inline const char* getValue(Tree* pTree)
    {
        return _getValue(pTree);
    }

    /** function 'getIntValue(...)'
     * Returns the value of a node as an integer.
     **/
    inline int getIntValue(Tree* pTree)
    {
        return _getIntValue(pTree);
    }

    /** function 'getDoubleValue(...)'
     * Returns the value of a node as a double.
     **/
    inline double getDoubleValue(Tree* pTree)
    {
        return _getDoubleValue(pTree);
    }

    /** function 'getBooleanValue(...)'
     * Returns the value of a node as a boolean.
     **/
    inline bool getBooleanValue(Tree* pTree)
    {
        return _getBooleanValue(pTree);
    }

    /** function 'getExternalValue(...)'
     * Returns the external instance of a node.
     **/
    inline CodeWorker::ExternalValueNode* getExternalValue(Tree* pTree)
    {
        return _getExternalValue(pTree);
    }

    /** function 'setValue(...)'
     * Assigns a value to a node.
     **/
    inline void setValue(Tree* pTree, const char* tcValue)
    {
        _setValue(pTree, tcValue);
    }

    /** function 'setIntValue(...)'
     * Assigns an integer value to a node.
     **/
    inline void setIntValue(Tree* pTree, int iValue)
    {
        _setIntValue(pTree, iValue);
    }

    /** function 'setDoubleValue(...)'
     * Assigns a double value to a node.
     **/
    inline void setDoubleValue(Tree* pTree, double dValue)
    {
        _setDoubleValue(pTree, dValue);
    }

    /** function 'setBooleanValue(...)'
     * Assigns a boolean value to a node.
     **/
    inline void setBooleanValue(Tree* pTree, bool bValue)
    {
        _setBooleanValue(pTree, bValue);
    }

    /** function 'setExternalValue(...)'
     * Assigns an external object type to a node.
     **/
    inline void setExternalValue(Tree* pTree, CodeWorker::ExternalValueNode* pInstance)
    {
        _setExternalValue(pTree, pInstance);
    }
     ...
     **/
    inline Tree* nextNode(Tree* pTree, const char* tcAttribute)
    {
        return _nextNode(pTree, tcAttribute);
    }
     ...
     **/
    inline Tree* insertNode(Tree* pTree, const char* tcAttribute)
    {
        return _insertNode(pTree, tcAttribute);
    }

    /** function 'clearNode(...)'
     * Clears the value and erases all subnodes.
     **/
    inline void  clearNode(Tree* pTree)
    {
        _clearNode(pTree);
    }
     ...
     **/
    inline int size(Tree* pTree)
    {
        return _sizeArray(pTree);
    }
     ...
     *   delete [] tcKeys;
     **/
    inline int allKeys(Tree* pTree, const char** tcKeys)
    {
        return _allKeys(pTree, tcKeys);
    }
     ...
     *   delete [] tcValues;
     **/
    inline int allValues(Tree* pTree, const char** tcValues)
    {
        return _allValues(pTree, tcValues);
    }
     ...
     **/
    inline Tree* getItem(Tree* pTree, const char* tcKey)
    {
        return _getItemFromKey(pTree, tcKey);
    }
     ...
     **/
    inline Tree* getItem(Tree* pTree, int iKey)
    {
        return _getItemFromPos(pTree, iKey);
    }
     ...
     **/
    inline const char* getItemKey(Tree* pTree, int iKey)
    {
        return _getItemKey(pTree, iKey);
    }
     ...
     **/
    inline Tree* pushItem(Tree* pArray, const char* tcValue = NULL)
    {
        return _pushItem(pArray, tcValue);
    }
     ...
     **/
    inline Tree* insertItem(Tree* pArray, const char* tcKey, const char* tcValue = NULL)
    {
        return _insertItem(pArray, tcKey, tcValue);
    }
     ...
     **/
    inline Function* findFunction(const char* tcFunctionName)
    {
        return _findFunction(this, tcFunctionName);
    }
     ...
     **/
    inline const char* callFunction(Function* pfFunction)
    {
        return _callFunction0(this, pfFunction);
    }
    inline const char* callFunction(Function* pfFunction, Parameter2CW p1)
    {
        return _callFunction1(this, pfFunction, p1);
    }
    inline const char* callFunction(Function* pfFunction, Parameter2CW p1, Parameter2CW p2)
    {
        return _callFunction2(this, pfFunction, p1, p2);
    }
    inline const char* callFunction(Function* pfFunction, Parameter2CW p1, Parameter2CW p2, Parameter2CW p3)
    {
        return _callFunction3(this, pfFunction, p1, p2, p3);
    }
    inline const char* callFunction(Function* pfFunction, Parameter2CW p1, Parameter2CW p2, Parameter2CW p3, Parameter2CW p4)
    {
        return _callFunction4(this, pfFunction, p1, p2, p3, p4);
    }

    inline void releaseFunction(Function* pfFunction)
    {
        _releaseFunction(pfFunction);
    }
