...
GrfIncrementIndentLevel::executeInternal(DtaScriptVariable& visibility)
{
...
void
GrfIncrementIndentLevel::populateDefaultParameters()
{
  if (_pLevel == NULL)
...
void
GrfIncrementIndentLevel::compileCpp(
