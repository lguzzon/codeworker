...
public:
    ...
    inline static bool existInstance()
    {
        return (_pInstance != NULL);
    }
    inline static DtaProject& getInstance()
    {
        return *_pInstance;
    }
    static DtaProject& createRootInstance();

    inline DtaScript* getScript() const
    {
        return _pScript;
    }
    inline void setScript(DtaScript* pScript)
    {
        _pScript = pScript;
    }
    ...
    inline void setVersion(const std::string& sVersion)
    {
        _sVersion = sVersion;
    }
    ...
    inline const std::string& getCodeWorkerHome() const
    {
        return _sCodeWorkerHome;
    }
    void setCodeWorkerHome(const std::string& sPath);
    inline const std::string& getMarkupKey() const
    {
        return _sMarkupKey;
    }
    inline void setMarkupKey(const std::string& sMarkupKey)
    {
        _sMarkupKey = sMarkupKey;
    }
    inline const std::string& getMarkupValue() const
    {
        return _sMarkupValue;
    }
    inline void setMarkupValue(const std::string& sMarkupValue)
    {
        _sMarkupValue = sMarkupValue;
    }
    inline const std::string& getWorkingPath() const
    {
        return _sWorkingPath;
    }
    inline void setWorkingPath(const std::string& sWorkingPath)
    {
        _sWorkingPath = sWorkingPath;
    }
    ...
    inline void setMapOfDefinedTargets(const std::map<std::string, std::string>& mapOfDefinedTargets)
    {
        _mapOfDefinedTargets = mapOfDefinedTargets;
    }
    inline const std::string& getCommentBegin() const
    {
        return _sCommentBegin;
    }
    inline void setCommentBegin(const std::string& sCommentBegin)
    {
        _sCommentBegin = sCommentBegin;
    }
    inline const std::string& getCommentEnd() const
    {
        return _sCommentEnd;
    }
    inline void setCommentEnd(const std::string& sCommentEnd)
    {
        _sCommentEnd = sCommentEnd;
    }
    inline const std::string& getGenerationHeader() const
    {
        return _sGenerationHeader;
    }
    inline void setGenerationHeader(const std::string& sGenerationHeader)
    {
        _sGenerationHeader = sGenerationHeader;
    }
    inline UtlTimer* getDelayTimer() const
    {
        return _pDelayTimer;
    }
    inline void setDelayTimer(UtlTimer* pTimer)
    {
        _pDelayTimer = pTimer;
    }
    double getLastDelay() const;
    inline void setLastDelay(double dDelay)
    {
        _dLastDelay = dDelay;
    }
    inline GrfReadonlyHook* getReadonlyHook() const
    {
        return _pReadonlyHook;
    }
    inline void setReadonlyHook(GrfReadonlyHook* pReadonlyHook)
    {
        _pReadonlyHook = pReadonlyHook;
    }
    inline GrfWritefileHook* getWritefileHook() const
    {
        return _pWritefileHook;
    }
    inline void setWritefileHook(GrfWritefileHook* pWritefileHook)
    {
        _pWritefileHook = pWritefileHook;
    }
    inline bool getSpeed() const
    {
        return _bSpeed;
    }
    inline void setSpeed(bool bSpeed)
    {
        _bSpeed = bSpeed;
    }
    inline TEXT_MODE getTextMode() const
    {
        return _iTextMode;
    }
    void setTextMode(TEXT_MODE iTextMode);
    inline bool noWarning(const std::string& sWarningType) const
    {
        return noWarnings_.find(sWarningType) != noWarnings_.end();
    }
    inline void addNoWarning(const std::string& sWarningType)
    {
        noWarnings_.insert(sWarningType);
    }
    inline const std::map<std::string, std::set<std::string> >& getCapturedOutputFiles() const
    {
        return _mapOfCapturedOutputFiles;
    }
    inline const std::map<std::string, std::set<std::string> >& getCapturedInputFiles() const
    {
        return _mapOfCapturedInputFiles;
    }
    void setFinalInfo(const std::string& sOutputFilename, int iFlag);
    inline const std::string& getFinalInfoOutputFilename() const
    {
        return sFinalInfoOutputFilename_;
    }
    inline int getFinalInfoFlag() const
    {
        return iFinalInfoFlag_;
    }
    void setRemoteDebug(const std::string& sHost, int iPort);
    inline const std::string& getRemoteDebugHost() const
    {
        return sRemoteDebugHost_;
    }
    inline int getRemoteDebugPort() const
    {
        return iRemoteDebugPort_;
    }
    ...
    inline bool hasTargetLanguage() const
    {
        return !_sTargetLanguage.empty();
    }
    inline void setTargetLanguage(const std::string& sTargetLanguage)
    {
    ...
    inline const std::string& getCurrentGenerationTagsHandler() const
    {
        return _sCurrentGenerationTagsHandler;
    }
