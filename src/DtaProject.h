...
public:
  ...
  {
    FINAL_INFO_GENERATED_FILES = 1,
    FINAL_INFO_PARSED_FILES = 2,
    FINAL_INFO_TEMPLATE_COVERAGE = 4,
    FINAL_INFO_PARSE_COVERAGE = 8,
    FINAL_INFO_TEMPLATE_COVERAGE_FOR_EVERYBODY = 16,
    FINAL_INFO_PARSE_COVERAGE_FOR_EVERYBODY = 32
  };
...
public:
  ...
  inline void setMapOfDefinedTargets(
    const std::map<std::string, std::string>& mapOfDefinedTargets)
  {
  ...
  getCapturedOutputFiles() const
  {
    return _mapOfCapturedOutputFiles;
  }
  inline const std::map<std::string, std::set<std::string>>&
  getCapturedInputFiles() const
  {
  ...
  static std::string getTargetScriptFilename(
  ...
  DtaScriptVariable* setGlobalVariable(
    const std::string& sName,
    EXPRESSION_TYPE variableType = NODE_EXPRTYPE);
  void setGlobalVariableType(const std::string& sName,
  ...
  bool addGenerationTagsHandler(const std::string& sKey,
  ...
  bool getGenerationTagsHandler(const std::string& sKey,
                                DtaBNFScript*& pReader,
  ...
  void captureOutputFile(const char* tcOutputFile,
