...
public:
    ...
    inline ExprScriptVariable* getErrorVariable() const
    {
        return _pVariable;
    }
    ...
    inline GrfBlock* getTryBlock() const
    {
        return _pTryBlock;
    }
    inline void setTryBlock(GrfBlock* pBlock)
    {
        _pTryBlock = pBlock;
    }
    inline GrfBlock* getCatchBlock() const
    {
        return _pCatchBlock;
    }
    inline void setCatchBlock(GrfBlock* pBlock)
    {
        _pCatchBlock = pBlock;
    }
