...
public:
    ...
    inline DtaScriptVariable* getNode() const
    {
        return _pNode;
    }
...
public:
    ...
    inline void setNode(DtaScriptVariable* pNode)
    {
        _pNode = pNode;
    }
    inline DtaScriptVariableList* getNext() const
    {
        return _pNext;
    }
    inline void setNext(DtaScriptVariableList* pNext)
    {
        _pNext = pNext;
    }
...
public:
    ...
    inline DtaScriptVariable* getParent() const
    {
        return _pParent;
    }
    ...
    bool isLocal() const;
    inline DtaScriptVariableList* getAttributes() const
    {
        return _pAttributes;
    }
