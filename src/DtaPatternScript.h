...
public:
    ...
    inline void setExecMode(bool bExecMode)
    {
    ...
    virtual SEQUENCE_INTERRUPTION_LIST generateString(std::string& sOutput, DtaScriptVariable& thisContext)
    {
        return _pOutputFile->generateString(sOutput, thisContext);
    }
    virtual SEQUENCE_INTERRUPTION_LIST expand(const char* sFile, DtaScriptVariable& thisContext)
    {
        return _pOutputFile->expand(sFile, thisContext);
    }
    virtual SEQUENCE_INTERRUPTION_LIST autoexpand(const char* sFile, DtaScriptVariable& thisContext)
    {
        return _pOutputFile->expand(sFile, thisContext);
    }

    inline ScpStream* openGenerate(bool bAutomatic, const char* sFile, ScpStream*& pOldOutputStream)
    {
        return _pOutputFile->openGenerate(bAutomatic, sFile, pOldOutputStream);
    }
    inline void catchGenerateExecution(bool bAutomatic, ScpStream* pOldOutputStream, UtlException* pCatchedException)
    {
        _pOutputFile->catchGenerateExecution(bAutomatic, pOldOutputStream, pCatchedException);
    }
    inline std::string closeGenerate(bool bAutomatic, const char* sFile, ScpStream* pOldOutputStream)
    {
    ...
    inline void populateProtectedArea(const std::string& sProtectedAreaName, const std::string& sContent)
    {
    ...
    inline bool weaveBeforeIteration(GrfJointPoint& jointPoint, DtaScriptVariable& context)
    {
        return _pOutputFile->weaveBeforeIteration(jointPoint, context);
    }
    inline bool weaveAroundIteration(GrfJointPoint& jointPoint, DtaScriptVariable& context)
    {
        return _pOutputFile->weaveAroundIteration(jointPoint, context);
    }
    inline bool weaveAfterIteration(GrfJointPoint& jointPoint, DtaScriptVariable& context)
    {
