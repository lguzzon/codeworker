...
public:
    ...
    inline void setBNFMode(bool bBNFMode)
    {
        _bBNFMode = bBNFMode;
    }
    inline IGNORE_MODE getIgnoreMode() const
    {
        return _eIgnoreMode;
    }
    inline void setIgnoreMode(IGNORE_MODE eMode)
    {
        _eIgnoreMode = eMode;
    }
    inline BNFClause* getIgnoreClause() const
    {
        return _pIgnoreClause;
    }
    inline void setIgnoreClause(BNFClause* pIgnoreClause)
    {
        _pIgnoreClause = pIgnoreClause;
    }
    inline bool implicitCopy() const
    {
        return _bImplicitCopy;
    }
    ...
    inline int getRatchetPosition() const
    {
        return _iRatchetPosition;
    }
    ...
    inline void incrementTraceIndentation()
    {
        _sTraceIndentation += " ";
    }
    ...
    inline BNFStepintoHook* getStepintoHook() const
    {
        return _pStepintoHook;
    }
    inline void setStepintoHook(BNFStepintoHook* pHook)
    {
        _pStepintoHook = pHook;
    }
    inline BNFStepoutHook* getStepoutHook() const
    {
        return _pStepoutHook;
    }
    inline void setStepoutHook(BNFStepoutHook* pHook)
    {
        _pStepoutHook = pHook;
    }
    ...
    inline ExprScriptVariable* getASTContainer() const
    {
        return _pASTContainer;
    }
    ...
    inline void setParentClauseMatching(BNFClauseMatchingArea* pParentClauseMatching)
    {
