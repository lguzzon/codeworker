...
public:
    ...
    inline bool getSortedNoCase() const
    {
        return _bSortedNoCase;
    }
    void setSortedNoCase(bool bSortedNoCase);
    inline bool getSortOnValue()
    {
        return _bSortOnValue;
    }
    ...
    inline CASCADING getCascading() const
    {
        return _iCascading;
    }
    inline void setCascading(CASCADING iCascading)
    {
        _iCascading = iCascading;
    }
