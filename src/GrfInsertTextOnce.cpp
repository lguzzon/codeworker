...
GrfInsertTextOnce::executeInternal(DtaScriptVariable& visibility)
{
  ...
  if ((*_pOutputCoverage != NULL) &&
      CGRuntime::getOutputStream()->insertTextOnce(sText, iLocation)) {
...
void
GrfInsertTextOnce::prepareCoverage(DtaScriptVariable* const* pOutputCoverage)
{
