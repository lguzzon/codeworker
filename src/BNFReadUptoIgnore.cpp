...
bool BNFReadUptoIgnore::isABNFCommand() const
{
    return true;
}
...
void BNFReadUptoIgnore::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
    ...
    CW_BODY_INDENT << "int _compilerClauseFirstLocation_" << iCursor << " = CGRuntime::getInputLocation();";
    CW_BODY_ENDL;
    CW_BODY_INDENT << "int _compilerClauseLastLocation_" << iCursor << " = _compilerClauseFirstLocation_" << iCursor << ";";
    CW_BODY_ENDL;
    ...
    CW_BODY_ENDL;
    CW_BODY_INDENT << "\tif (_compilerClauseLastLocation_" << iCursor << " != CGRuntime::getInputLocation()) break;";
    CW_BODY_ENDL;
    CW_BODY_INDENT << "}";
    CW_BODY_ENDL;
    CW_BODY_INDENT << "_compilerClauseSuccess = (_compilerClauseFirstLocation_" << iCursor << " != _compilerClauseLastLocation_" << iCursor << ");";
    CW_BODY_ENDL;
    ...
    if (!_listOfConstants.empty()) {
        ...
        CW_BODY_ENDL;
        CW_BODY_INDENT << "\t_compilerClauseText_" << iCursor << " = CGRuntime::getLastReadChars(_compilerClauseLastLocation_" << iCursor << " - _compilerClauseFirstLocation_" << iCursor << ");";
        CW_BODY_ENDL;
    ...
    CW_BODY_INDENT << "\tCGRuntime::writeBinaryData(_compilerClauseText_" << iCursor << ".c_str(), _compilerClauseText_" << iCursor << ".size());";
    CW_BODY_ENDL;
    CW_BODY_INDENT << "}";
    CW_BODY_ENDL;
}
