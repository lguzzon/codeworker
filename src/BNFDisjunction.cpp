...
BNFDisjunction::BNFDisjunction(DtaBNFScript* pBNFScript, GrfBlock* pParent)
...
void
BNFDisjunction::accept(DtaVisitor& visitor, DtaVisitorEnvironment& env)
{
  visitor.visitBNFDisjunction(*this, env);
}

bool
BNFDisjunction::isABNFCommand() const
{
  return true;
}

SEQUENCE_INTERRUPTION_LIST
BNFDisjunction::execute(DtaScriptVariable& visibility)
{
...
void
BNFDisjunction::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
