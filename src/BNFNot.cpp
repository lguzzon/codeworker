...
BNFNot::BNFNot(DtaBNFScript* pBNFScript, GrfBlock* pParent, bool bContinue)
...
void
BNFNot::accept(DtaVisitor& visitor, DtaVisitorEnvironment& env)
{
  visitor.visitBNFNot(*this, env);
}

bool
BNFNot::isABNFCommand() const
{
  return true;
}

SEQUENCE_INTERRUPTION_LIST
BNFNot::executeInternal(DtaScriptVariable& visibility)
{
...
void
BNFNot::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
