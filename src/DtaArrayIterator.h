...
public:
  inline DtaArrayIterator(const DtaArrayIterator& copy)
    : _iCurrentPosition(copy._iCurrentPosition)
    , _pItemNoRef(NULL)
  {}
  inline DtaArrayIterator()
    : _iCurrentPosition(0)
    , _pItemNoRef(NULL)
  {}
...
public:
  inline DtaListIterator(const DtaListIterator& copy)
    : DtaArrayIterator(copy)
    , _list(copy._list)
    , i(copy.i)
  {}
  inline DtaListIterator(const std::list<DtaScriptVariable*>& listOfNodes)
    : _list(listOfNodes)
    , i(listOfNodes.begin())
  {}
...
public:
  inline DtaReverseListIterator(const DtaReverseListIterator& copy)
    : DtaArrayIterator(copy)
    , _list(copy._list)
    , i(copy.i)
  {}
  inline DtaReverseListIterator(
    const std::list<DtaScriptVariable*>& listOfNodes)
    : _list(listOfNodes)
