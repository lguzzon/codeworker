    ...
    if (i != getCommands().end()) {
        ...
        if (!_listOfConstants.empty() || (_pVariableToAssign != 0) || !_listOfIntermediateConstants.empty() || (_pIntermediateVariableToAssign != 0) || !_listOfFinalConstants.empty() || (_pFinalVariableToAssign != 0)) {
            ...
            if (!_listOfIntermediateConstants.empty() || (_pIntermediateVariableToAssign != 0) || !_listOfFinalConstants.empty() || (_pFinalVariableToAssign != 0)) {
                CW_BODY_INDENT << "int _compilerClauseIntermediateLocation_" << iCursor << " = _compilerClauseNotEmptyLocation_" << iCursor << ";";
                CW_BODY_ENDL;
            }
        }
        ...
        if (_pBoundaries != 0) {
            if (!_pBoundaries->bConstantBoundaries) {
                throw UtlException("BNFFindToken::compileCpp(): variable boundaries not handled yet!");
            }

            CW_BODY_INDENT << "int _compilerClauseLoop_" << iCursor << ";";
            CW_BODY_ENDL;
            CW_BODY_INDENT << "int _compilerClauseBegin_" << iCursor << " = " << _pBoundaries->choice.constant._iBegin << ";";
            CW_BODY_ENDL;
            CW_BODY_INDENT << "int _compilerClauseEnd_" << iCursor << " = " << _pBoundaries->choice.constant._iEnd << ";";
            CW_BODY_ENDL;
            CW_BODY_INDENT << "for (_compilerClauseLoop_" << iCursor << " = 0; (_compilerClauseLoop_" << iCursor << " <= _compilerClauseBegin_" << iCursor << ") || (_compilerClauseEnd_" << iCursor << " < 0) || (_compilerClauseLoop_" << iCursor << " <= _compilerClauseEnd_" << iCursor << "); ++_compilerClauseLoop_" << iCursor << ") {";
            CW_BODY_ENDL;
        } else {
            CW_BODY_INDENT << "for (;;) {";
            CW_BODY_ENDL;
        ...
        CW_BODY_ENDL;
        CW_BODY_INDENT << "int _compilerClauseStartToken_" << iCursor << " = CGRuntime::getInputLocation();";
        CW_BODY_ENDL;
        CW_BODY_INDENT << "if (_compilerClauseNextLocation_" << iCursor << " > _compilerClauseStartToken_" << iCursor << ") {";
        CW_BODY_ENDL;
        CW_BODY_INDENT << "\tCGRuntime::setInputLocation(_compilerClauseNextLocation_" << iCursor << ");";
        CW_BODY_ENDL;

        if (!_listOfIntermediateConstants.empty() || (_pIntermediateVariableToAssign != 0) || !_listOfFinalConstants.empty() || (_pFinalVariableToAssign != 0)) {
            CW_BODY_INDENT << "\t_compilerClauseIntermediateLocation_" << iCursor << " = _compilerClauseNextLocation_" << iCursor << ";";
            CW_BODY_ENDL;
        }

        CW_BODY_INDENT << "\tif (" << tcImplicitCopy << " >= 0) {";
        CW_BODY_ENDL;
        CW_BODY_INDENT << "\t\tstd::string sText = CGRuntime::getLastReadChars(_compilerClauseNextLocation_" << iCursor << " - _compilerClauseStartToken_" << iCursor << ");";
        CW_BODY_ENDL;
        CW_BODY_INDENT << "\t\ttheEnvironment.writeBinaryData(sText.c_str(), sText.size());";
        CW_BODY_ENDL;
        CW_BODY_INDENT << "\t}";
        CW_BODY_ENDL;
        ...
        if (!_listOfIntermediateConstants.empty() || (_pIntermediateVariableToAssign != 0) || !_listOfFinalConstants.empty() || (_pFinalVariableToAssign != 0)) {
            CW_BODY_INDENT << "\t_compilerClauseIntermediateLocation_" << iCursor << " = _compilerClauseStartToken_" << iCursor << " + 1;";
            CW_BODY_ENDL;
        }
        ...
        if (_pBoundaries != 0) {
            CW_BODY_INDENT << "_compilerClauseSuccess = _compilerClauseSuccess && (_compilerClauseLoop_" << iCursor << " >= _compilerClauseBegin_" << iCursor << ");";
            CW_BODY_ENDL;
        }
        ...
        if (!_listOfConstants.empty() || (_pVariableToAssign != 0) || !_listOfIntermediateConstants.empty() || (_pIntermediateVariableToAssign != 0) || !_listOfFinalConstants.empty() || (_pFinalVariableToAssign != 0)) {
            ...
            CW_BODY_ENDL;
            theCompilerEnvironment.incrementIndentation();
            CW_BODY_INDENT << "int _compilerClauseCurrentLocation_" << iCursor << " = CGRuntime::getInputLocation();";
            CW_BODY_ENDL;
            ...
            if (!_listOfIntermediateConstants.empty() || (_pIntermediateVariableToAssign != 0)) {
                ...
                CW_BODY_INDENT << "CGRuntime::setInputLocation(_compilerClauseIntermediateLocation_" << iCursor << ");";
                CW_BODY_ENDL;
                ...
                CW_BODY_STREAM << "CGRuntime::setInputLocation(_compilerClauseCurrentLocation_" << iCursor << ");";
                CW_BODY_ENDL;
...
{
    if (!listOfConstants.empty()) {
        CW_BODY_INDENT << "std::string _compilerClauseText_" << iCursor << " = CGRuntime::getLastReadChars(_compilerClause" << sEndLocation << "_" << iCursor << " - _compilerClause" << sBeginLocation << "_" << iCursor << ");";
        CW_BODY_ENDL;
