...
public:
    ...
    virtual void onSetValue(const char* tcValue)
    {
        onHasChanged();
    }
    virtual void onConcatValue(const char* tcValue)
    {
        onHasChanged();
    }
    virtual void onSetReference(DtaScriptVariable* pReference)
    {
        onHasChanged();
    }
    ...
    virtual void onAddAttribute(DtaScriptVariable* pAttribute)
    {
        onHasChanged();
    }
    ...
    virtual void onArrayHasChanged()
    {
        onHasChanged();
    }
...
public:
    ...
    static void unactivateCurrentDebugger()
    {
        _pActiveDebugger = NULL;
    }
