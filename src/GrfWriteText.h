...
#ifndef _GrfWriteText_h_
#define _GrfWriteText_h_
...
class GrfWriteText : public GrfCommand
{
private:
...
public:
  ...
  virtual ~GrfWriteText();

  virtual const char* getFunctionName() const { return "writeText"; }
