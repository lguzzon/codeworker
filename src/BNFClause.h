...
public:
    ...
    inline const std::string& getTemplateKey() const
    {
        return _sTemplateKey;
    }
    inline BNFClause* getTemplateClause() const
    {
        return _pTemplateClause;
    }
    ...
    {
        return (_pTemplateClause != NULL) || !_mapOfTemplateInstantiations.empty() || (_pGenericTemplateClause != NULL);
    }
    ...
    inline void setReturnType(int iReturnType)
    {
        _iReturnType = iReturnType;
    }
    ...
    inline const std::string& getParameter(int i) const
    {
    ...
    inline bool isPropagatedParameter() const
    {
        return _bPropagatedParameters;
    }
    ...
    inline BNFClause* getOverloadClause() const
    {
        return _pOverloadClause;
    }
