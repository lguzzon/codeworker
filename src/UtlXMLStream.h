...
public:
  inline UtlXMLStream(std::ostream& myStream)
  ...
  virtual void writeAttribute(const std::string& sName,
  ...
  virtual void writeHashtableEntry(const std::string& sKey,
                                   const std::string& sValue);
  virtual void writeHashtableEntry(const std::string& sKey, double dValue);
  virtual void writeHashtableEntry(const std::string& sKey,
                                   const std::vector<double>& listOfValues);
  virtual void writeHashtableEntry(
    const std::string& sKey,
    const std::vector<std::string>& listOfValues);
  virtual void writeHashtableEntry(int iKey, int iValue);
  virtual void writeBeginningOfAggregation(const std::string& sOwnerClass,
                                           const std::string& sName);
  virtual void writeEndOfAggregation(const std::string& sOwnerClass,
                                     const std::string& sName);
  virtual void writeBeginningOfAssociation(const std::string& sOwnerClass,
                                           const std::string& sName);
  virtual void writeEndOfAssociation(const std::string& sOwnerClass,
                                     const std::string& sName);
  virtual void writeObjectReference(const std::string& sTypeName,
...
public:
  ...
  virtual bool readHashtableEntry(std::string& sKey,
                                  std::vector<double>& listOfValues);
  virtual bool readHashtableEntry(std::string& sKey,
                                  std::vector<std::string>& listOfValues);
  virtual bool readBeginningOfAggregation(std::string& sOwnerClass,
                                          std::string& sName);
  virtual bool readEndOfAggregation(std::string& sOwnerClass,
                                    std::string& sName);
  virtual bool readBeginningOfAssociation(std::string& sOwnerClass,
                                          std::string& sName);
  virtual bool readEndOfAssociation(std::string& sOwnerClass,
                                    std::string& sName);
  virtual bool readObjectReference(std::string& sTypeName,
