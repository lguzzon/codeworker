...
#ifndef _BNFReadCString_h_
#define _BNFReadCString_h_
...
class BNFReadCString : public GrfCommand
{
private:
...
public:
    BNFReadCString(DtaBNFScript* pBNFScript, GrfBlock* pParent, bool bContinue, bool bNoCase);
    virtual ~BNFReadCString();
