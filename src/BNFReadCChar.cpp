...
bool BNFReadCChar::isABNFCommand() const
{
    return true;
}
...
void BNFReadCChar::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
    ...
    CW_BODY_ENDL;
    CW_BODY_INDENT << "std::string _compilerClauseText_" << iCursor << " = CGRuntime::readCChar();";
    CW_BODY_ENDL;
    CW_BODY_INDENT << "_compilerClauseSuccess = (_compilerClauseNotEmptyLocation_" << iCursor << " != _compilerClauseLocation_" << iCursor << ");";
    CW_BODY_ENDL;
