...
#ifndef _GrfInsertText_h_
#define _GrfInsertText_h_
...
public:
  ...
  static int shiftCoverageItem(DtaScriptVariable* pCoverage,
                               int iLocation,
                               int iLength);
  static DtaScriptVariable* getCoverageItem(DtaScriptVariable* pCoverage,
                                            int iLocation,
                                            int iLength,
