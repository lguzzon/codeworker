...
public:
    ...
    virtual bool isAFunctionExpression() const
    {
        return false;
    }
...
public:
    ...
    inline const std::string& getConstant() const
    {
        return _sValue;
    }
...
public:
    ...
    inline DtaScriptVariable* getVariable() const
    {
        return _pVariable;
    }
...
public:
    inline ExprScriptScriptFile(ExprScriptExpression* pFileName) : _bFileName(true)
    {
        script._pFileName = pFileName;
    }
    inline ExprScriptScriptFile(DtaScript* pBody) : _bFileName(false)
    {
        script._pBody = pBody;
    }
    ~ExprScriptScriptFile();

    inline bool isFileName() const
    {
        return _bFileName;
    }
    inline ExprScriptExpression* getFileName() const
    {
        return script._pFileName;
    }
    inline DtaScript* getBody() const
    {
        return script._pBody;
    }
