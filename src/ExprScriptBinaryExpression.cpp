...
std::string ExprScriptComparison::getValue(DtaScriptVariable& visibility) const
{
    ...
    default:
        throw UtlException("ExprScriptComparison::getValue(): undefined comparison type");
    }
...
std::string ExprScriptComparison::toString() const
{
    ...
    default:
        throw UtlException("ExprScriptComparison::toString(): undefined comparison operator");
    }
...
bool ExprScriptComparison::compileCppBoolean(CppCompilerEnvironment& theCompilerEnvironment, bool bNegative) const
{
    ...
    default:
        throw UtlException("ExprScriptComparison::compileCppBoolean(): undefined comparison type");
    }
...
std::string ExprScriptNumericComparison::getValue(DtaScriptVariable& visibility) const
{
    ...
    default:
        throw UtlException("ExprScriptNumericComparison::getValue(): undefined comparison type");
    }
...
bool ExprScriptNumericComparison::compileCppBoolean(CppCompilerEnvironment& theCompilerEnvironment, bool bNegative) const
{
    ...
    default:
        throw UtlException("ExprScriptNumericComparison::compileCppBoolean(): undefined comparison type");
    }
...
std::string ExprScriptBoolean::getValue(DtaScriptVariable& visibility) const
{
    ...
    default:
        throw UtlException("ExprScriptBoolean::getValue(): undefined comparison type");
    }
...
std::string ExprScriptBoolean::toString() const
{
    ...
    default:
        throw UtlException("ExprScriptBoolean::toString(): undefined boolean operator");
    }
...
bool ExprScriptBoolean::compileCppBoolean(CppCompilerEnvironment& theCompilerEnvironment, bool bNegative) const
{
    ...
    default:
        throw UtlException("ExprScriptBoolean::compileCppBoolean(): undefined boolean operator");
    }
