...
public:
    ExprScriptVariable(ExprScriptVariable* pParent, const char* sName) : _sName(sName), _pNext(NULL), _pExpression(NULL), _iAccess(ATTRIBUTE_ACCESS), _pPackage(NULL)
    {
    ...
    inline bool isAttributeOnly() const
    {
        return _iAccess == ATTRIBUTE_ACCESS;
    }
    inline bool isAttribute() const
    {
        return (_iAccess & ATTRIBUTE_ACCESS) != 0;
    }
    ...
    {
        return (_iAccess & NEXT_ACCESS) != 0;
    }
    inline ExprScriptVariable* getNext() const
    {
        return _pNext;
    }
    ...
    {
        return ((_iAccess & ARRAY_KEY_ACCESS) == ARRAY_KEY_ACCESS) ? _pExpression : NULL;
    }
    ...
    {
        return ((_iAccess & ARRAY_POSITION_ACCESS) == ARRAY_POSITION_ACCESS) ? _pExpression : NULL;
    }
    ...
    {
        return ((_iAccess & EVALUATION_ACCESS) == EVALUATION_ACCESS) ? _pExpression : NULL;
    }
    ...
    inline DynPackage* getPackage() const
    {
        return _pPackage;
    }
    void setPackage(DynPackage* pPackage)
    {
        _pPackage = pPackage;
    }
