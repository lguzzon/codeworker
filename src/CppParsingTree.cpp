...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set value \"" + std::string(tcValue) + "\" to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set value \"" + sValue + "\" to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set a numeric to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set a boolean to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set an integer to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set a value to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to set an array of strings to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to concatenate value \"" + sValue + "\" to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to concatenate a value to an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to assign a reference to an empty node");
    }

    if (reference._pInternalNode == NULL) {
        throw UtlException("internal error: trying to assign an empty node as reference");
    }
...
void CppParsingTree_var::setAll(const CppParsingTree_var& tree) const
{
    if (tree._pInternalNode == NULL) {
        throw UtlException("internal error: trying to assign an empty subtree to a node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to push a value to the array of an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to add elements to the array of an empty node");
    }
...
{
    if (_pInternalNode == NULL) {
        return std::auto_ptr<std::vector<DtaScriptVariable*> >(new std::vector<DtaScriptVariable*>());
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to insert an evaluated node '" + sDynamicVariable + "' into an empty tree");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to insert '" + sKey + "' key node into an empty array");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to insert key node into an empty array");
    }
...
{
    if (_pInternalNode == NULL) {
        throw UtlException("internal error: trying to insert key node into an empty tree");
    }
