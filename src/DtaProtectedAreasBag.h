...
public:
    ...
    inline void setDefine(const std::string& sDefine)
    {
        _sDefine = sDefine;
    }
    inline const std::string& getDefine() const
    {
        return _sDefine;
    }
    ...
    inline bool isAlreadyGenerated() const
    {
        return _bIsAlreadyGenerated;
    }
};
...
public:
    ...
    inline const std::map<std::string, DtaProtectedArea*>& getProtectedAreas() const
    {
        return _codes;
    }
