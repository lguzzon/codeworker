...
void
GrfGenerate::setPatternFileName(ExprScriptScriptFile* pPatternFileName)
{
...
GrfGenerate::executeInternal(DtaScriptVariable& visibility)
{
  ...
  SEQUENCE_INTERRUPTION_LIST result =
    executeScript(sOutputFile.c_str(), pClass, executeFunction);
  switch (result) {
...
SEQUENCE_INTERRUPTION_LIST
GrfGenerate::executeScript(const char* sOutputFile,
...
void
GrfGenerate::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
