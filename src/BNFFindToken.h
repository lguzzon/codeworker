...
public:
    ...
    inline void setIntermediateConstantsToMatch(const std::vector<std::string>& listOfConstants)
    {
    ...
    inline void setFinalConstantsToMatch(const std::vector<std::string>& listOfConstants)
    {
        _listOfFinalConstants = listOfConstants;
    }
    inline bool hasIntermediateCode() const
    {
        return (_pIntermediateVariableToAssign != NULL) || !_listOfIntermediateConstants.empty() || (_pIntermediateSequence != NULL) || !_listOfFinalConstants.empty() || (_pFinalVariableToAssign != NULL);
    }
