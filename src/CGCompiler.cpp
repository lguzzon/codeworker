...
void CGCompiledCommonScript::execute(DtaScriptVariable* pContext)
{
    ...
    if (_pScript == NULL) {
        throw UtlException("the common script is missing; specify it before an execution");
    }
...
void CGCompiledTemplateScript::generate(DtaScriptVariable* pContext, const std::string& sOutputFile)
{
    ...
    if (_pScript == NULL) {
        throw UtlException("the template-based script is missing; specify it before an execution");
    }
...
void CGCompiledBNFScript::parse(DtaScriptVariable* pContext, const std::string& sParsedFile)
{
    ...
    if (_pScript == NULL) {
        throw UtlException("the BNF parse script is missing; specify it before an execution");
    }
...
void CGCompiledTranslationScript::translate(DtaScriptVariable* pContext, const std::string& sParsedFile, const std::string& sOutputFile)
{
    ...
    if (_pScript == NULL) {
        throw UtlException("the translation script is missing; specify it before an execution");
    }
