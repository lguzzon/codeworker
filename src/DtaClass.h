...
public:
    ...
    inline EXPRESSION_TYPE getId() const
    {
        return _iId;
    }
    inline GrfBlock* getBlock() const
    {
        return _pBlock;
    }
    inline void setBlock(GrfBlock* pBlock)
    {
        _pBlock = pBlock;
    }
    inline DtaClass* getExtendedClass() const
    {
        return _pExtendedClass;
    }
...
public:
    ...
    inline const std::string& getTypeSpecifier() const
    {
        return getName();
    }
    virtual std::string getCppTypeSpecifier() const;
