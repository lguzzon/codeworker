...
const char* BNFReadIdentifier::getFunctionName() const
{
    return "#readIdentifier";
}
std::string BNFReadIdentifier::executeExtraction(DtaScriptVariable&) const
{
    return CGRuntime::readIdentifier();
}
std::string BNFReadIdentifier::compileCppExtraction() const
{
    return "CGRuntime::readIdentifier()";
}
}
