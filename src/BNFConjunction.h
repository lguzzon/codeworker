...
#ifndef _BNFConjunction_h_
#define _BNFConjunction_h_
...
class BNFConjunction : public GrfBlock
{
private:
    DtaBNFScript* _pBNFScript;

public:
    BNFConjunction(DtaBNFScript* pBNFScript, GrfBlock* pParent);
    virtual ~BNFConjunction();
