...
typedef std::string (*EXTERNAL_TEMPLATE_DISPATCHER_FUNCTION)(
  const std::string&,
  CppParsingTree_var**);
#endif
...
public:
  ...
  inline static DtaScriptVariable& getThisInternalNode()
  {
    return *(_pThisTree._pInternalNode);
  }
  static CppParsingTree_var getRootTree();

  inline static GrfJointPoint* getActiveJointPoint() { return _pJointPoint; }

  inline static CGExternalHandling* getExternalHandling()
  {
    return _pExternalHandling;
  }
  inline static void setExternalHandling(CGExternalHandling* pExternalHandling)
  {
    _pExternalHandling = pExternalHandling;
  }

  static void registerExternalFunction(const std::string& sKey,
                                       EXTERNAL_FUNCTION externalFunction);
  static void registerExternalTemplateDispatcherFunction(
  ...
  static void throwBNFExecutionError(
    const std::string& sBNFToken,
    const char* tcComment = NULL) throw(UtlException);

  static int entryPoint(int iNargs,
                        char** tsArgs,
  ...
  static void registerScript(const char* sRegistration,
                             EXECUTE_FUNCTION* executeFunction);
  ...
  static void expand(EXECUTE_FUNCTION* executeFunction,
                     CppParsingTree_var pThisTree,
                     const std::string& sFilename);
  static void expand(const std::string& sScriptFile,
                     CppParsingTree_var pThisTree,
                     const std::string& sFilename);
  static void autoexpand(const std::string& sFileName,
                         CppParsingTree_var pThisTree);
  static void generate(EXECUTE_FUNCTION* executeFunction,
                       CppParsingTree_var pThisTree,
                       const std::string& sFilename);
  static void generate(const std::string& sScriptFile,
                       CppParsingTree_var pThisTree,
                       const std::string& sFilename);
  static void generateString(EXECUTE_FUNCTION* executeFunction,
                             CppParsingTree_var pThisTree,
                             CppParsingTree_var pOutput);
  static void parseFree(EXECUTE_FUNCTION* executeFunction,
                        CppParsingTree_var pThisTree,
                        const std::string& sFilename);
  static void parseAsBNF(EXECUTE_FUNCTION* executeFunction,
                         CppParsingTree_var pThisTree,
                         const std::string& sFilename);
  static void parseAsBNF(const std::string& sGrammarFile,
                         CppParsingTree_var pThisTree,
                         const std::string& sFilename);
  static void parseStringAsBNF(EXECUTE_FUNCTION* executeFunction,
                               CppParsingTree_var pThisTree,
                               const std::string& sContent);
  static void translate(EXECUTE_FUNCTION* executeFunction,
                        CppParsingTree_var pThisTree,
  ...
  static SEQUENCE_INTERRUPTION_LIST writeBinaryData(const char* sText,
                                                    int iLength);
  ...
  static std::list<DtaScriptVariable*>::const_iterator nextIteration(
    std::list<DtaScriptVariable*>::const_iterator i);
  static std::map<std::string, DtaScriptVariable*>::const_iterator
  nextIteration(std::map<std::string, DtaScriptVariable*>::const_iterator i);

  //##markup##"functions and procedures"
  //##begin##"functions and procedures"
  static SEQUENCE_INTERRUPTION_LIST appendFile(const std::string& sFilename,
                                               const std::string& sContent);
  ...
  static SEQUENCE_INTERRUPTION_LIST compileToCpp(
    const std::string& sScriptFileName,
    const std::string& sProjectDirectory,
    const std::string& sCodeWorkerDirectory);
  static SEQUENCE_INTERRUPTION_LIST copyFile(
    const std::string& sSourceFileName,
    const std::string& sDestinationFileName);
  static SEQUENCE_INTERRUPTION_LIST copyGenerableFile(
    const std::string& sSourceFileName,
    const std::string& sDestinationFileName);
  static SEQUENCE_INTERRUPTION_LIST copySmartDirectory(
    const std::string& sSourceDirectory,
    const std::string& sDestinationPath);
  static SEQUENCE_INTERRUPTION_LIST cutString(const std::string& sText,
  ...
  static SEQUENCE_INTERRUPTION_LIST extendExecutedScript(
    const std::string& sScriptContent);
  static SEQUENCE_INTERRUPTION_LIST insertElementAt(DtaScriptVariable* pList,
                                                    const std::string& sKey,
                                                    int iPosition);
  static SEQUENCE_INTERRUPTION_LIST insertElementAt(CppParsingTree_var pList,
                                                    const std::string& sKey,
                                                    int iPosition);
  ...
  static SEQUENCE_INTERRUPTION_LIST listAllGeneratedFiles(
    DtaScriptVariable* pFiles);
  static SEQUENCE_INTERRUPTION_LIST listAllGeneratedFiles(
    CppParsingTree_var pFiles);
  static SEQUENCE_INTERRUPTION_LIST loadProject(
    const std::string& sXMLorTXTFileName,
  ...
  static SEQUENCE_INTERRUPTION_LIST produceHTML(
    const std::string& sScriptFileName,
    const std::string& sHTMLFileName);
  static SEQUENCE_INTERRUPTION_LIST putEnv(const std::string& sName,
                                           const std::string& sValue);
  static SEQUENCE_INTERRUPTION_LIST randomSeed(int iSeed);
  static SEQUENCE_INTERRUPTION_LIST removeAllElements(
    DtaScriptVariable* pVariable);
  static SEQUENCE_INTERRUPTION_LIST removeAllElements(
    CppParsingTree_var pVariable);
  static SEQUENCE_INTERRUPTION_LIST removeElement(DtaScriptVariable* pVariable,
                                                  const std::string& sKey);
  static SEQUENCE_INTERRUPTION_LIST removeElement(CppParsingTree_var pVariable,
                                                  const std::string& sKey);
  static SEQUENCE_INTERRUPTION_LIST removeFirstElement(
  ...
  static SEQUENCE_INTERRUPTION_LIST removeRecursive(
    DtaScriptVariable* pVariable,
  ...
  static SEQUENCE_INTERRUPTION_LIST saveBinaryToFile(
    const std::string& sFilename,
    const std::string& sContent);
  static SEQUENCE_INTERRUPTION_LIST saveProject(
    const std::string& sXMLorTXTFileName,
    DtaScriptVariable* pNodeToSave);
  static SEQUENCE_INTERRUPTION_LIST saveProject(
    const std::string& sXMLorTXTFileName,
    CppParsingTree_var pNodeToSave);
  static SEQUENCE_INTERRUPTION_LIST saveProjectTypes(
    const std::string& sXMLFileName);
  static SEQUENCE_INTERRUPTION_LIST saveToFile(const std::string& sFilename,
                                               const std::string& sContent);
  static SEQUENCE_INTERRUPTION_LIST setCommentBegin(
    const std::string& sCommentBegin);
  static SEQUENCE_INTERRUPTION_LIST setCommentEnd(
    const std::string& sCommentEnd);
  static SEQUENCE_INTERRUPTION_LIST setGenerationHeader(
    const std::string& sComment);
  static SEQUENCE_INTERRUPTION_LIST setIncludePath(const std::string& sPath);
  static SEQUENCE_INTERRUPTION_LIST setNow(
    const std::string& sConstantDateTime);
  static SEQUENCE_INTERRUPTION_LIST setProperty(const std::string& sDefine,
                                                const std::string& sValue);
  ...
  static SEQUENCE_INTERRUPTION_LIST slideNodeContent(
    DtaScriptVariable* pOrgNode,
    ExprScriptVariable& xDestNode);
  static SEQUENCE_INTERRUPTION_LIST slideNodeContent(
    CppParsingTree_var pOrgNode,
  ...
  static SEQUENCE_INTERRUPTION_LIST traceObject(DtaScriptVariable* pObject,
                                                int iDepth);
  static SEQUENCE_INTERRUPTION_LIST traceObject(CppParsingTree_var pObject,
                                                int iDepth);
  ...
  static SEQUENCE_INTERRUPTION_LIST allFloatingLocations(
    DtaScriptVariable* pList);
  static SEQUENCE_INTERRUPTION_LIST allFloatingLocations(
    CppParsingTree_var pList);
  ...
  static SEQUENCE_INTERRUPTION_LIST insertText(int iLocation,
                                               const std::string& sText);
  static SEQUENCE_INTERRUPTION_LIST insertTextOnce(int iLocation,
                                                   const std::string& sText);
  static SEQUENCE_INTERRUPTION_LIST insertTextToFloatingLocation(
    const std::string& sLocation,
    const std::string& sText);
  static SEQUENCE_INTERRUPTION_LIST insertTextOnceToFloatingLocation(
    const std::string& sLocation,
    const std::string& sText);
  static SEQUENCE_INTERRUPTION_LIST overwritePortion(int iLocation,
                                                     const std::string& sText,
                                                     int iSize);
  static SEQUENCE_INTERRUPTION_LIST populateProtectedArea(
    const std::string& sProtectedAreaName,
    const std::string& sContent);
  static SEQUENCE_INTERRUPTION_LIST resizeOutputStream(int iNewSize);
  static SEQUENCE_INTERRUPTION_LIST setFloatingLocation(const std::string& sKey,
                                                        int iLocation);
  static SEQUENCE_INTERRUPTION_LIST setOutputLocation(int iLocation);
  static SEQUENCE_INTERRUPTION_LIST setProtectedArea(
    const std::string& sProtectedAreaName);
  ...
  static std::string addToDate(const std::string& sDate,
  ...
  static int changeFileTime(const std::string& sFilename,
  ...
  static std::string completeDate(const std::string& sDate,
                                  const std::string& sFormat);
  ...
  static bool copySmartFile(const std::string& sSourceFileName,
                            const std::string& sDestinationFileName);
  static std::string coreString(const std::string& sText,
                                int iPos,
                                int iLastRemoved);
  static int countStringOccurences(const std::string& sString,
                                   const std::string& sText);
  static bool createDirectory(const std::string& sPath);
  static int createINETClientSocket(const std::string& sRemoteAddress,
                                    int iPort);
  ...
  static bool createReverseIterator(DtaScriptVariable* pI,
                                    DtaScriptVariable* pList);
  static bool createReverseIterator(CppParsingTree_var pI,
                                    CppParsingTree_var pList);
  static bool createVirtualFile(const std::string& sHandle,
                                const std::string& sContent);
  ...
  static bool duplicateIterator(DtaScriptVariable* pOldIt,
                                DtaScriptVariable* pNewIt);
  static bool duplicateIterator(CppParsingTree_var pOldIt,
  ...
  static bool equalsIgnoreCase(const std::string& sLeft,
                               const std::string& sRight);
  static bool equalTrees(DtaScriptVariable* pFirstTree,
                         DtaScriptVariable* pSecondTree);
  static bool equalTrees(CppParsingTree_var pFirstTree,
                         CppParsingTree_var pSecondTree);
  static std::string executeStringQuiet(DtaScriptVariable* pThis,
                                        const std::string& sCommand);
  static std::string executeStringQuiet(CppParsingTree_var pThis,
                                        const std::string& sCommand);
  ...
  static bool exploreDirectory(DtaScriptVariable* pDirectory,
                               const std::string& sPath,
                               bool bSubfolders);
  static bool exploreDirectory(CppParsingTree_var pDirectory,
                               const std::string& sPath,
                               bool bSubfolders);
  static std::string extractGenerationHeader(const std::string& sFilename,
  ...
  static bool findElement(const std::string& sValue,
                          DtaScriptVariable* pVariable);
  static bool findElement(const std::string& sValue,
                          CppParsingTree_var pVariable);
  static int findFirstChar(const std::string& sText,
                           const std::string& sSomeChars);
  static int findFirstSubstringIntoKeys(const std::string& sSubstring,
                                        DtaScriptVariable* pArray);
  static int findFirstSubstringIntoKeys(const std::string& sSubstring,
                                        CppParsingTree_var pArray);
  static int findLastString(const std::string& sText, const std::string& sFind);
  static int findNextString(const std::string& sText,
                            const std::string& sFind,
                            int iPosition);
  static int findNextSubstringIntoKeys(const std::string& sSubstring,
                                       DtaScriptVariable* pArray,
                                       int iNext);
  static int findNextSubstringIntoKeys(const std::string& sSubstring,
                                       CppParsingTree_var pArray,
  ...
  static std::string formatDate(const std::string& sDate,
                                const std::string& sFormat);
  ...
  static std::string getHTTPRequest(const std::string& sURL,
  ...
  static int getVariableAttributes(DtaScriptVariable* pVariable,
                                   DtaScriptVariable* pList);
  static int getVariableAttributes(CppParsingTree_var pVariable,
                                   CppParsingTree_var pList);
  ...
  static std::string joinStrings(DtaScriptVariable* pList,
                                 const std::string& sSeparator);
  static std::string joinStrings(CppParsingTree_var pList,
                                 const std::string& sSeparator);
  ...
  static std::string postHTTPRequest(const std::string& sURL,
                                     DtaScriptVariable* pHTTPSession,
                                     DtaScriptVariable* pArguments);
  static std::string postHTTPRequest(const std::string& sURL,
                                     CppParsingTree_var pHTTPSession,
  ...
  static std::string relativePath(const std::string& sPath,
  ...
  static std::string replaceString(const std::string& sOld,
  ...
  static bool scanDirectories(DtaScriptVariable* pDirectory,
                              const std::string& sPath,
                              const std::string& sPattern);
  static bool scanDirectories(CppParsingTree_var pDirectory,
                              const std::string& sPath,
                              const std::string& sPattern);
  static bool scanFiles(DtaScriptVariable* pFiles,
                        const std::string& sPath,
                        const std::string& sPattern,
                        bool bSubfolders);
  static bool scanFiles(CppParsingTree_var pFiles,
                        const std::string& sPath,
                        const std::string& sPattern,
                        bool bSubfolders);
  static bool sendBinaryToSocket(int iSocket, const std::string& sBytes);
  static std::string sendHTTPRequest(const std::string& sURL,
                                     DtaScriptVariable* pHTTPSession);
  static std::string sendHTTPRequest(const std::string& sURL,
                                     CppParsingTree_var pHTTPSession);
  ...
  static std::string truncateAfterString(DtaScriptVariable* pVariable,
                                         const std::string& sText);
  static std::string truncateAfterString(CppParsingTree_var pVariable,
                                         const std::string& sText);
  static std::string truncateBeforeString(DtaScriptVariable* pVariable,
                                          const std::string& sText);
  static std::string truncateBeforeString(CppParsingTree_var pVariable,
                                          const std::string& sText);
  ...
  static bool extractGenerationHeader(ScpStream& theStream,
                                      std::string& sGenerator,
                                      std::string& sVersion,
                                      std::string& sDate,
                                      std::string& sComment);
...
private:
  static void populateDirectory(DtaScriptVariable* pDirectory,
                                UtlDirectory& theDirectory,
                                bool bSubfolders);
  static void populateFileScan(DtaScriptVariable* pFiles,
                               UtlDirectory& theDirectory,
                               bool bSubfolders);
  static void copySmartDirectory(UtlDirectory& theDirectory,
                                 const std::string& sDestinationPath);
  static bool convertBytesToChars(const std::string& sBytes,
                                  unsigned char* tcBuffer,
                                  int iLength);
  static void convertCharsToBytes(const unsigned char* tcBuffer,
                                  char* tcContent,
                                  int iLength);
...
private:
  ...
  static std::map<std::string, EXTERNAL_FUNCTION>&
  getExternalFunctionsRegister();
  static std::map<std::string, EXTERNAL_TEMPLATE_DISPATCHER_FUNCTION>&
  getExternalTemplateDispatcherFunctionsRegister();
};
...
public:
  inline CGThisModifier(CppParsingTree_var& pThisTree)
    : _pOldThis(&CGRuntime::getThisInternalNode())
  {
    CGRuntime::_pThisTree = pThisTree;
  }
  inline CGThisModifier(DtaScriptVariable* pThisTree)
    : _pOldThis(&CGRuntime::getThisInternalNode())
  {
...
public:
  inline DEFAULT_EXECUTE_CLAUSE(EXECUTE_CLAUSE_FUNCTION executeClause)
...
public:
  struct CGMatchingAreas
  {
    ...
    inline CGMatchingAreas(const char* c, int i)
      : clause(c)
      , beginPosition(i)
      , endPosition(-1)
    {}
...
public:
  inline CGBNFRuntimeEnvironment(EXECUTE_CLAUSE* executeClause,
                                 int iIgnoreMode,
                                 bool bImplicitCopy)
    : _executeClause(executeClause)
    , _iIgnoreMode(iIgnoreMode)
    , _bImplicitCopy(bImplicitCopy)
    , _pMatchingAreas(NULL)
  {}
  ~CGBNFRuntimeEnvironment();

  inline bool implicitCopy() const { return _bImplicitCopy; }
  void pushIgnoreMode(CGBNFRuntimeIgnore& ignoreMode,
                      int iNewIgnoreMode,
                      EXECUTE_CLAUSE* newExecuteClause);
  void popIgnoreMode(const CGBNFRuntimeIgnore& ignoreMode);
  void pushImplicitCopy(CGBNFRuntimeTransformationMode& transformationMode,
                        bool bNewImplicitCopy);
  void popImplicitCopy(
    const CGBNFRuntimeTransformationMode& transformationMode);

  inline void addClauseSignature(const std::string& sSignature)
  {
    _clauseSignatures.push_back(sSignature);
  }
  ...
  inline void writeBinaryData(unsigned char cChar)
  {
    writeBinaryData((const char*)&cChar, 1);
  }

private:
  void storeClauseMatching(
...
public:
  inline CGBNFRuntimeIgnore(CGBNFRuntimeEnvironment& theBNFRuntimeEnvironment,
                            int iNewIgnoreMode,
                            EXECUTE_CLAUSE* newExecuteClause)
    : _pBNFRuntimeEnvironment(&theBNFRuntimeEnvironment)
  {
    _pBNFRuntimeEnvironment->pushIgnoreMode(
      *this, iNewIgnoreMode, newExecuteClause);
  }
  inline ~CGBNFRuntimeIgnore()
  {
    _pBNFRuntimeEnvironment->popIgnoreMode(*this);
  }
};
...
public:
  inline CGBNFRuntimeTransformationMode(
    CGBNFRuntimeEnvironment& theBNFRuntimeEnvironment,
    bool bNewImplicitCopy)
    : _pBNFRuntimeEnvironment(&theBNFRuntimeEnvironment)
  {
    _pBNFRuntimeEnvironment->pushImplicitCopy(*this, bNewImplicitCopy);
  }
  inline ~CGBNFRuntimeTransformationMode()
  {
    _pBNFRuntimeEnvironment->popImplicitCopy(*this);
  }
};
...
public:
  inline CGJointPointStack(GrfJointPoint* pJointPoint)
    : _pOldJointPoint(CGRuntime::_pJointPoint)
  {
    CGRuntime::_pJointPoint = pJointPoint;
  }
...
public:
  inline CGBNFClauseScope()
    : _pLocalVariables(NULL)
  {}
  ~CGBNFClauseScope();

  CppParsingTree_var getNode(const std::string& sName) const;
  CppParsingTree_var getEvaluatedNode(
    const std::string& sDynamicVariable) const;
  ...
  CppParsingTree_var insertClassicalEvaluatedNode(
