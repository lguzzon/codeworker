...
public:
    ...
    inline static CppParsingTree_var getThisTree()
    {
        return _pThisTree;
    }
    ...
    inline static GrfJointPoint* getActiveJointPoint()
    {
        return _pJointPoint;
    }
    ...
    inline static ScpStream* getOutputStream()
    {
        return _pOutputStream;
    }
    inline static ScpStream* getInputStream()
    {
...
public:
    ...
    virtual bool run(CGBNFRuntimeEnvironment& env)
    {
        return _executeClause(env);
    }
};
...
public:
    struct CGMatchingAreas {
        ...
        ~CGMatchingAreas();
        inline void pushChild(CGMatchingAreas* pChild)
        {
...
public:
    ...
    inline CGMatchingAreas* getMatchingAreas() const
    {
        return _pMatchingAreas;
    }
...
public:
    inline CGBNFRuntimeIgnore(CGBNFRuntimeEnvironment& theBNFRuntimeEnvironment, int iNewIgnoreMode, EXECUTE_CLAUSE* newExecuteClause) : _pBNFRuntimeEnvironment(&theBNFRuntimeEnvironment)
    {
        _pBNFRuntimeEnvironment->pushIgnoreMode(*this, iNewIgnoreMode, newExecuteClause);
    }
...
public:
    inline CGBNFRuntimeTransformationMode(CGBNFRuntimeEnvironment& theBNFRuntimeEnvironment, bool bNewImplicitCopy) : _pBNFRuntimeEnvironment(&theBNFRuntimeEnvironment)
    {
...
public:
    inline CGJointPointStack(GrfJointPoint* pJointPoint) : _pOldJointPoint(CGRuntime::_pJointPoint)
    {
