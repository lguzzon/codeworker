...
#ifndef _GrfParseStringAsBNF_h_
#define _GrfParseStringAsBNF_h_
...
class GrfParseStringAsBNF : public GrfCommand
{
private:
...
public:
  GrfParseStringAsBNF();
  virtual ~GrfParseStringAsBNF();

  virtual const char* getFunctionName() const { return "parseStringAsBNF"; }
