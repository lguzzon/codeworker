...
void
BNFInsert::accept(DtaVisitor& visitor, DtaVisitorEnvironment& env)
{
  visitor.visitBNFInsert(*this, env);
}

bool
BNFInsert::isABNFCommand() const
{
  return true;
}

SEQUENCE_INTERRUPTION_LIST
BNFInsert::execute(DtaScriptVariable& visibility)
{
...
void
BNFInsert::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
