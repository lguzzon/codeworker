...
#ifndef _BNFReadByte_h_
#define _BNFReadByte_h_
...
public:
  ...
  virtual void setConstantsToMatch(
    const std::vector<std::string>& listOfConstants);

  virtual std::string toString() const;

protected:
  virtual void postExecutionAssignment(DtaScriptVariable& variable,
                                       unsigned char cChar);

  virtual void compileCppAssignment(
