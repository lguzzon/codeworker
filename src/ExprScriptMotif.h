...
public:
    ...
    inline ExprScriptMotifPath* getNextPath() const
    {
        return _pNextPath;
    }
    ...
    inline bool startNode() const
    {
        return _pPrecedentPath == NULL;
    }
    inline bool endNode() const
    {
        return _pNextPath == NULL;
    }
};
...
public:
    inline ExprScriptMotifBoolean(char cOperator, ExprScriptMotif* pMember) : _cOperator(cOperator)
    {
