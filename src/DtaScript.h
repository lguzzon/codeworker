...
public:
    ...
    static inline bool requiresParsingInformation()
    {
        return _bParseWithSymbols;
    }
    ...
    inline GrfBlock& getBlock()
    {
        return _graph;
    }
    void setFilename(const char* sFilename);
    inline void setFilenamePtr(const char* tcFilePtr)
    {
        _tcFilePtr = tcFilePtr;
    }
    inline const char* getFilenamePtr() const
    {
        return _tcFilePtr;
    }
