...
#ifndef _GrfSetInputLocation_h_
#define _GrfSetInputLocation_h_
...
class GrfSetInputLocation : public GrfCommand
{
private:
...
public:
  GrfSetInputLocation()
    : _pLocation(NULL)
  {}
  virtual ~GrfSetInputLocation();

  virtual const char* getFunctionName() const { return "setInputLocation"; }
