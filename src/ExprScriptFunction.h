...
public:
  ...
  const std::vector<ExprScriptExpression*>& getParameters() const
  {
    return _parameters;
  }
  ...
  inline void setTemplate(ExprScriptExpression* pTemplate)
  {
  ...
  static ExprScriptFunction* create(GrfBlock& block,
                                    ...
                                    bool bGenericKey);
  static ExprScriptFunction* createMethod(GrfBlock& block,
                                          ScpStream& script,
                                          const std::string& sFunction,
                                          const std::string& sTemplate,
                                          bool bGenericKey);
