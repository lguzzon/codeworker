...
#ifndef _BNFReadAdaString_h_
#define _BNFReadAdaString_h_
...
class BNFReadAdaString : public GrfCommand
{
private:
...
public:
    BNFReadAdaString(DtaBNFScript* pBNFScript, GrfBlock* pParent, bool bContinue, bool bNoCase);
    virtual ~BNFReadAdaString();
