...
bool Workspace::executeArguments(int iNargs, char** tsArgs, EXECUTE_FUNCTION* executeFunction)
{
            ...
            if ((sFileExtension != ".cwt") && (sFileExtension != ".cwp") && (sFileExtension != ".cws") && (sFileExtension != ".gen")) {
                ...
                if (sFileExtension == ".cwp") {
                    ...
                    if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                        throw UtlException("command-line processing: input filename expected after the BNF parsing script");
                    }
    ...
    if ((iNargs >= 2) && (stricmp(tsArgs[1], "-commands") == 0)) {
        ...
        if (iNargs != 3) {
            throw UtlException("command-line processing: '-commands' expects a file name and nothing else behind");
        }
    ...
    while (i < iNargs) {
        if (tsArgs[i][0] == '-') {
            ...
            if (stricmp(tcCommand, "script") == 0) {
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: script filename expected after '-script'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-script' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: script filename expected after '-compile'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-compile' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: script filename expected after '-parseBNF'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-parseBNF' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: input filename expected after '-parseBNF <BNF-parsing-script>'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: script filename expected after '-generate'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-generate' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: generated filename expected after '-generate <patternFile>'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: script filename expected after '-expand'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-expand' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: generated filename expected after '-expand <patternFile>'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: filename expected after '-autoexpand'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-autoexpand' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: filename of a BNF parsing script expected after '-translate'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-translate' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: source file expected after '-translate <BNF-script>'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: generated file expected after '-translate <BNF-script> <source-file>'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: variable expected after '-insert'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: value expected after '-insert'");
                }
                ...
                if (theCommand.getInputLocation() != (int) sVariable.size()) {
                    throw UtlException("option '-insert': syntax error on the variable expression");
                }
                ...
                if ((i < iNargs) && (tsArgs[i][0] != '-')) {
                    ...
                    if (iIndex == std::string::npos) {
                        throw UtlException("command-line processing: ':' expected to separate host and port after '-debug'");
                    }
                    ...
                    if (iPort <= 0) {
                        throw UtlException("command-line processing: valid socket port expected after '-debug'");
                    }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: version name expected after '-version'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: directory expected after '-c++'");
                }

                if (!_sCppCompilation.empty()) {
                    throw UtlException("command-line processing: C++ project directory is given twice (switch '-c++')");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: script filename expected after '-c++2target'");
                }

                if (_iScriptMode != NONE) {
                    throw UtlException("command-line processing: '-c++2target' isn't allowed: another script mode has already been specified");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: directory expected after '-c++2target'");
                }

                if (!_sCppCompilation.empty()) {
                    throw UtlException("command-line processing: C++ project directory is given twice (switch '-c++2target')");
                }
                ...
                if ((i < iNargs) && (tsArgs[i][0] != '-')) {
                    ...
                    if (DtaProject::getInstance().hasTargetLanguage() && (DtaProject::getInstance().getTargetLanguage() != sTargetLanguage)) {
                        throw UtlException("command-line processing: do not specify more than one target language (switch '-c++2target')");
                    }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: C++ filename expected after '-c++sp'");
                }

                if (!_sCppServerPage.empty()) {
                    throw UtlException("command-line processing: C++ filename is given twice for server pages");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: CodeWorker path expected after '-home'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: comment expected after '-genheader'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: filename expected after '-stdin'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: filename expected after '-stdout'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: depth expected after '-stack'");
                }

                int iStackDepth = atoi(tsArgs[i]);

                if (iStackDepth <= 0) {
                    throw UtlException("command-line processing: invalid depth given after '-stack'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: working path expected after '-path'");
                }

                sWorkingPath = readArgument(tsArgs, i);

                if ((sWorkingPath[sWorkingPath.size() - 1] != '\\') && (sWorkingPath[sWorkingPath.size() - 1] != '/')) {
                    sWorkingPath += '/';
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: define target expected after '-define'");
                }
                ...
                if (iIndex != std::string::npos) {
                    if (iIndex == 0) {
                        throw UtlException("target name expected on the left side of '=' for define directive");
                    }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: include path expected after '-I'");
                }

                std::string sIncludePath = readArgument(tsArgs, i);

                if ((sIncludePath[sIncludePath.size() - 1] != '\\') && (sIncludePath[sIncludePath.size() - 1] != '/')) {
                    sIncludePath += '/';
                }
                ...
                if (i >= iNargs) {
                    throw UtlException("command-line processing: format of a beginning of comment expected after '-commentBegin'");
                }
                ...
                if (i >= iNargs) {
                    throw UtlException("command-line processing: end of comment format expected after '-commentEnd'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: output file name expected after '-report'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: flag expected as the second argument of '-report'");
                }
                ...
                if (iFlag <= 0) {
                    throw UtlException("command-line processing: invalid flag passed to '-report'");
                }
                ...
                if ((i >= iNargs) || (tsArgs[i][0] == '-')) {
                    throw UtlException("command-line processing: warning types expected after '-nowarn'");
                }
                ...
                throw UtlException(std::string("command-line processing: unknown option '-") + (tcCommand) + "'");
            }
        ...
        if ((_iScriptMode != AUTO_EXPAND) && (_sScriptFileName.empty() || (executeFunction != NULL))) {
            if (executeFunction != NULL) {
                if	(_iScriptMode == PARSE_BNF)	{
                    CGRuntime::parseAsBNF(executeFunction, CGRuntime::getRootTree(), _sParsedFileName);
                } else if	(_iScriptMode == EXPAND)	{
                    CGRuntime::expand(executeFunction, CGRuntime::getRootTree(), _sGeneratedFileName);
                } else if	(_iScriptMode == TRANSLATE)	{
                    CGRuntime::translate(executeFunction, CGRuntime::getRootTree(), _sParsedFileName, _sGeneratedFileName);
                } else if	(_iScriptMode == GENERATE)	{
                    CGRuntime::generate(executeFunction, CGRuntime::getRootTree(), _sGeneratedFileName);
                } else {
                    executeFunction->run();
                }
            }
                ...
                if (!_sCppCompilation.empty()) {
                    ...
                    if (_iScriptMode == TARGET) {
                        ...
                        if (sTargetLanguage.empty()) {
                            throw UtlException("unknown target language: should have been specified on switch -c++2target");
                        }
...
void ExecuteServerPageCppHeader::run()
{
    ...
    if (tcClassName == NULL) {
        throw UtlException("while generating the C++ external stub: no class name specified!");
    }
    ...
    for (std::list<GrfFunction*>::const_iterator i = workspace_._listOfExternalFunctions.begin(); i != workspace_._listOfExternalFunctions.end(); ++i) {
        ...
        for (std::list<std::string>::const_iterator j = pFunction->getParameters().begin(); j != pFunction->getParameters().end(); j++, iIndex++) {
            if ((j != pFunction->getParameters().begin()) || pFunction->isATemplateDispatcher()) {
                CGRuntime::writeText(", ");
            }
