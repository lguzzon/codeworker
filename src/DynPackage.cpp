...
public:
  inline Parameter2CW(const char* tcValue)
    : _bValue(true)
  {
    _param._tcValue = tcValue;
  }
  inline Parameter2CW(Tree* pNode)
    : _bValue(false)
  {
    _param._pNode = pNode;
  }
  ...
  {
    return ((_bValue) ? _param._tcValue : NULL);
  }
...
typedef bool (
  *CREATE_COMMAND4)(DynPackage*, const char*, bool, bool, bool, bool);
...
typedef const char* (*CALL_FUNCTION1)(Interpreter* pInterpreter,
                                      Function*,
                                      Parameter2CW);
typedef const char* (*CALL_FUNCTION2)(Interpreter* pInterpreter,
                                      Function*,
                                      Parameter2CW,
                                      Parameter2CW);
typedef const char* (*CALL_FUNCTION3)(Interpreter* pInterpreter,
                                      Function*,
                                      Parameter2CW,
                                      Parameter2CW,
                                      Parameter2CW);
typedef const char* (*CALL_FUNCTION4)(Interpreter* pInterpreter,
                                      Function*,
                                      Parameter2CW,
                                      Parameter2CW,
                                      Parameter2CW,
...
bool
pfCreateCommand0(DynPackage* pPackage, const char* tcName)
{
  return pPackage->addFunction(tcName);
}

bool
pfCreateCommand1(DynPackage* pPackage, const char* tcName, bool bIsP1Node)
{
  return pPackage->addFunction(tcName, bIsP1Node);
}

bool
pfCreateCommand2(DynPackage* pPackage,
                 const char* tcName,
                 bool bIsP1Node,
                 bool bIsP2Node)
{
...
bool
pfCreateCommand3(DynPackage* pPackage,
                 const char* tcName,
                 bool bIsP1Node,
                 bool bIsP2Node,
                 bool bIsP3Node)
...
bool
pfCreateCommand4(DynPackage* pPackage,
                 const char* tcName,
                 bool bIsP1Node,
                 bool bIsP2Node,
                 bool bIsP3Node,
                 bool bIsP4Node)
{
  return pPackage->addFunction(
    tcName, bIsP1Node, bIsP2Node, bIsP3Node, bIsP4Node);
}

bool
pfCreateCommandN(DynPackage* pPackage,
                 const char* tcName,
                 int iNbParams,
                 int* tbNodeParams)
{
...
Tree*
pfCreateVariable(DynPackage* pPackage, const char* tcName)
{
  return pPackage->addVariable(tcName);
}

void
pfError(const char* tcError)
{
  throw UtlException(tcError);
}

const char*
pfCopyLocalString(Interpreter* pInterpreter, const char* tcText);
const char*
pfCopyLocalBoolean(Interpreter* pInterpreter, bool bValue);
const char*
pfCopyLocalDouble(Interpreter* pInterpreter, double dValue);
const char*
pfCopyLocalInt(Interpreter* pInterpreter, int iValue);
...
const char*
pfGetValue(Tree* pNode)
{
  return pNode->getValue();
}

int
pfGetIntValue(Tree* pNode)
{
  return pNode->getIntValue();
}

double
pfGetDoubleValue(Tree* pNode)
{
  return pNode->getDoubleValue();
}

bool
pfGetBooleanValue(Tree* pNode)
{
  return pNode->getBooleanValue();
}

ExternalValueNode*
pfGetExternalValue(Tree* pNode)
{
  return pNode->getExternalValueNode();
}

void
pfSetValue(Tree* pNode, const char* tcValue)
{
  pNode->setValue(tcValue);
}

void
pfSetExternalValue(Tree* pNode, ExternalValueNode* pValue)
{
  pNode->setValue(pValue);
}

void
pfSetIntValue(Tree* pNode, int iValue)
{
  pNode->setValue(iValue);
}

void
pfSetDoubleValue(Tree* pNode, double dValue)
{
  pNode->setValue(dValue);
}

void
pfSetBooleanValue(Tree* pNode, bool bValue)
{
  pNode->setValue(bValue);
}

Tree*
pfNextNode(Tree* pNode, const char* tcAttribute)
{
  return pNode->getNode(tcAttribute);
}

Tree*
pfInsertNode(Tree* pNode, const char* tcAttribute)
{
  return pNode->insertNode(tcAttribute);
}

void
pfClearNode(Tree* pNode)
{
  pNode->clearContent();
}

int
pfSizeArray(Tree* pArray)
{
  return pArray->getArraySize();
}

int
pfAllKeys(Tree* pArray, const char** tcKeys)
{
  const std::list<DtaScriptVariable*>* pArrayList = pArray->getArray();
  if (pArrayList == NULL)
    return 0;
  int iIndex = 0;
  for (std::list<DtaScriptVariable*>::const_iterator i = pArrayList->begin();
       i != pArrayList->end();
       i++) {
...
int
pfAllValues(Tree* pArray, const char** tcValues)
{
  const std::list<DtaScriptVariable*>* pArrayList = pArray->getArray();
  if (pArrayList == NULL)
    return 0;
...
Tree*
pfGetItemFromKey(Tree* pArray, const char* tcKey)
{
  return pArray->getArrayElement(tcKey);
}

Tree*
pfGetItemFromPos(Tree* pArray, int iKey)
{
  return pArray->getArrayElement(iKey);
}

const char*
pfGetItemKey(Tree* pArray, int iKey)
{
...
Tree*
pfPushItem(Tree* pArray, const char* tcValue)
{
  if (tcValue == NULL)
    return pArray->pushItem("");
  return pArray->pushItem(tcValue);
}

Tree*
pfInsertItem(Tree* pArray, const char* tcKey, const char* tcValue)
{
  DtaScriptVariable* pItem = pArray->addElement(tcKey);
  if (tcValue != NULL)
    pItem->setValue(tcValue);
  return pItem;
}

Function*
pfFindFunction(Interpreter* pInterpreter, const char* sFunctionName);

const char*
pfCallFunction0(Interpreter* pInterpreter, Function* pFunction);
const char*
pfCallFunction1(Interpreter* pInterpreter,
                Function* pFunction,
                Parameter2CW p1);
const char*
pfCallFunction2(Interpreter* pInterpreter,
                Function* pFunction,
                Parameter2CW p1,
                Parameter2CW p2);
const char*
pfCallFunction3(Interpreter* pInterpreter,
                Function* pFunction,
                Parameter2CW p1,
                Parameter2CW p2,
                Parameter2CW p3);
const char*
pfCallFunction4(Interpreter* pInterpreter,
                Function* pFunction,
                Parameter2CW p1,
                Parameter2CW p2,
                Parameter2CW p3,
...
void
pfReleaseFunction(Function* pFunction)
{
  delete pFunction;
}
...
public:
  ...
  inline void setVisibitity(DtaScriptVariable* pVisibility)
  {
...
pfFindFunction(Interpreter* pInterpreter, const char* sFunctionName)
{
  if (pInterpreter->getPackage()->getBlock() == NULL)
    return NULL;
  ScpStream script("");
  ExprScriptFunction* pFunction = ExprScriptFunction::create(
    *pInterpreter->getPackage()->getBlock(), script, sFunctionName, "", false);
  return pFunction;
}
...
void
populateFunctionWithParameterExpression(Function* pFunction,
                                        ...
                                        Parameter2CW& p)
{
  if ((eType & 0x00FF) == VALUE_EXPRTYPE) {
    if (p.isValue()) {
      ...
      if (tcValue == NULL)
        pConstant = new ExprScriptConstant;
      else
        pConstant = new ExprScriptConstant(tcValue);
...
const char*
pfCallFunction1(Interpreter* pInterpreter, Function* pFunction, Parameter2CW p1)
{
  static std::string sValue;
  if (pFunction == NULL)
    return NULL;
  ...
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(0), p1);
  sValue = pFunction->getValue(*pInterpreter->getVisibility());
  return sValue.c_str();
}
                ...
                Parameter2CW p2)
{
  ...
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(0), p1);
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(1), p2);
  sValue = pFunction->getValue(*pInterpreter->getVisibility());
  return sValue.c_str();
}
                ...
                Parameter2CW p3)
{
  ...
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(1), p2);
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(2), p3);
  sValue = pFunction->getValue(*pInterpreter->getVisibility());
  return sValue.c_str();
}
                ...
                Parameter2CW p4)
{
  ...
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(2), p3);
  populateFunctionWithParameterExpression(
    pFunction, pFunction->getParameterType(3), p4);
  sValue = pFunction->getValue(*pInterpreter->getVisibility());
  return sValue.c_str();
}

Interpreter::Interpreter(DynPackage* pPackage)
  : _pPackage(pPackage)
  , _tcLocalString(NULL)
{
...
void
Interpreter::prepare(DtaScriptVariable& pVisibility)
{
  _pVisibility = &pVisibility;
  free(_tcLocalString);
  _tcLocalString = NULL;
...
DynFunction::DynFunction(Interpreter* pInterpreter,
                         const char* tcName,
                         bool bIsP1Node)
  : GrfFunction(NULL, tcName, "", false)
  , _pInterpreter(pInterpreter)
{
  init();
  addParameterAndType(
    "p1", ((bIsP1Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
}
  ...
  , _pInterpreter(pInterpreter)
{
  ...
  addParameterAndType(
    "p1", ((bIsP1Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
  addParameterAndType(
    "p2", ((bIsP2Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
}
  ...
  , _pInterpreter(pInterpreter)
{
  ...
  addParameterAndType(
    "p2", ((bIsP2Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
  addParameterAndType(
    "p3", ((bIsP3Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
}
  ...
  , _pInterpreter(pInterpreter)
{
  ...
  addParameterAndType(
    "p3", ((bIsP3Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
  addParameterAndType(
    "p4", ((bIsP4Node) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
}
  ...
  , _pInterpreter(pInterpreter)
{
  ...
  for (int i = 0; i < iNbParams; i++) {
    ...
    addParameterAndType(
      tcParam, ((tbNodeParams[i] != 0) ? NODE_EXPRTYPE : VALUE_EXPRTYPE), NULL);
  }
}
...
std::string
DynFunction::launchExecution(DtaScriptVariable& visibility,
                             const ExprScriptFunction& functionCall,
                             const std::string& sInstantiationKey)
{
  ...
  try {
    const std::vector<ExprScriptExpression*>& parameters =
    ...
    for (std::vector<ExprScriptExpression*>::const_iterator i =
      ...
      switch (*k & 0x00FF) {
        case VALUE_EXPRTYPE: {
          ...
          if (sValue.empty()) {
            ExprScriptVariable* pExprVar =
              dynamic_cast<ExprScriptVariable*>(*i);
        ...
        case NODE_EXPRTYPE: {
          ExprScriptResolvedVariable* pResolvedVariable =
            dynamic_cast<ExprScriptResolvedVariable*>(*i);
          if (pResolvedVariable == NULL) {
            ExprScriptVariable* pVarExpr =
              dynamic_cast<ExprScriptVariable*>(*i);
            if (pVarExpr == NULL) {
              throw UtlException("bad parameter passed to the function '" +
                                 _pInterpreter->getPackage()->getName() +
                                 "::" + std::string(getFunctionName()) + "()'");
            }
            DtaScriptVariable* pVariable =
              visibility.getVariable((const ExprScriptVariable&)*(*i));
    ...
    switch (getArity()) {
      ...
      case 3:
        sResult =
          call(visibility, tParameters[0], tParameters[1], tParameters[2]);
        break;
      case 4:
        sResult = call(visibility,
                       tParameters[0],
    ...
    delete[] tParameters;
    std::string sMessage = "an ellipsis exception has occurred in " +
                           _sModuleName + ", function " + getName();
    throw UtlException(sMessage);
  }
  for (std::string::size_type iIndex = 0; iIndex < getArity(); iIndex++) {
    if ((getParameterType(iIndex) & 0x00FF) == VALUE_EXPRTYPE)
...
std::string
DynFunction::call(DtaScriptVariable& pVisibility)
{
...
std::string
DynFunction::call(DtaScriptVariable& pVisibility, Parameter p1)
{
  _pInterpreter->prepare(pVisibility);
...
std::string
DynFunction::call(DtaScriptVariable& pVisibility, Parameter p1, Parameter p2)
{
  _pInterpreter->prepare(pVisibility);
...
std::string
DynFunction::call(DtaScriptVariable& pVisibility, Parameter* tParams)
{
  _pInterpreter->prepare(pVisibility);
...
void
DynFunction::compileCppFunctionNameForCalling(
  CppCompilerEnvironment& theCompilerEnvironment)
{
  CW_BODY_STREAM << _pInterpreter->getPackage()->getName()
                 << "::instance()._compilerFunction_" << getFunctionName();
  if (!theCompilerEnvironment.getIncludeParentScript().empty()) {
    ...
    CW_BODY_STREAM.insertTextOnce("// header file for the dynamic module '" +
                                    _pInterpreter->getPackage()->getName() +
                                    "'" + ScpStream::ENDL + "#include \"" +
                                    _pInterpreter->getPackage()->getName() +
                                    ".h\"" + ScpStream::ENDL + ScpStream::ENDL,
                                  iInsertAreaLocation);
  }
}
...
DynPackage::DynPackage(const std::string& sPackage)
  : _sPackage(sPackage)
  , _pBlock(NULL)
  , _hHandle(0)
  , _pInterpreter(NULL)
...
DynPackage::DynPackage(const std::string& sPackage, GrfBlock& block)
  : _sPackage(sPackage)
  , _pBlock(&block)
  , _hHandle(0)
  , _pInterpreter(NULL)
...
void
DynPackage::initialize()
{
  _hHandle = loadPackage(_sPackage + "cw");
  _pInterpreter = new Interpreter(this);

  LIBRARY_INIT_FUNCTION pfInit =
    (LIBRARY_INIT_FUNCTION)findFunction(_hHandle, _sPackage + "_Init");
  if (pfInit == NULL) {
    throw UtlException("unable to find the init function " + _sPackage +
                       "_Init(CW4dl::Interpreter*) in module " + _sPackage +
                       "cw");
  }
  try {
    ...
    throw UtlException(
      "ellipsis exception while initializing the module " + _sPackage +
      "cw: is the interpreter's version the same as the module?");
  }
...
DynPackage::~DynPackage()
{
  ...
  for (std::map<std::string, DynFunction*>::iterator i = _functions.begin();
       i != _functions.end();
       i++) {
    delete i->second;
  }
  for (std::map<std::string, DtaScriptVariable*>::iterator j =
         _variables.begin();
       j != _variables.end();
       j++) {
    delete j->second;
...
DynFunction*
DynPackage::getFunction(const std::string& sFunction) const
{
  std::map<std::string, DynFunction*>::const_iterator cursor =
    _functions.find(sFunction);
  if (cursor == _functions.end())
    return NULL;
  return cursor->second;
}

bool
DynPackage::addFunction(const char* tcName)
{
  return addFunction(new DynFunction(_pInterpreter, tcName));
}

bool
DynPackage::addFunction(const char* tcName, bool bIsP1Node)
{
  return addFunction(new DynFunction(_pInterpreter, tcName, bIsP1Node));
}

bool
DynPackage::addFunction(const char* tcName, bool bIsP1Node, bool bIsP2Node)
{
  return addFunction(
    new DynFunction(_pInterpreter, tcName, bIsP1Node, bIsP2Node));
}
...
{
  return addFunction(
    new DynFunction(_pInterpreter, tcName, bIsP1Node, bIsP2Node, bIsP3Node));
}
...
DynPackage::addFunction(const char* tcName,
                        ...
                        bool bIsP4Node)
{
  return addFunction(new DynFunction(
    _pInterpreter, tcName, bIsP1Node, bIsP2Node, bIsP3Node, bIsP4Node));
}

bool
DynPackage::addFunction(const char* tcName, int iNbParams, int* tbNodeParams)
{
  return addFunction(
    new DynFunction(_pInterpreter, tcName, iNbParams, tbNodeParams));
}

bool
DynPackage::addFunction(DynFunction* pFunction)
{
  ...
  if (pfFunctionCall == NULL) {
    std::string sError = "the module '" + _sPackage +
                         "' doesn't export the function '" + _sPackage + "::";
    sError += pFunction->getFunctionName();
    sError += "'";
    delete pFunction;
    throw UtlException(sError);
...
DtaScriptVariable*
DynPackage::getVariable(const std::string& sVariable) const
{
  std::map<std::string, DtaScriptVariable*>::const_iterator cursor =
    _variables.find(sVariable);
  if (cursor == _variables.end())
    return NULL;
  return cursor->second;
}
...
DynPackage*
DynPackage::getPackage(const std::string& sPackage)
{
  std::map<std::string, DynPackage*>::iterator cursor =
    _packages.find(sPackage);
  if (cursor == _packages.end())
    return NULL;
  return cursor->second;
}

DynPackage*
DynPackage::addPackage(const std::string& sPackage, GrfBlock& block)
{
...
LIBRARY_HANDLE
DynPackage::loadPackage(const std::string& sLibrary)
{
  ...
  if (hModule == NULL) {
    ...
    if (hModule == NULL) {
      ...
      if (ScpStream::existInputFileFromIncludePath(sLibraryWithExt.c_str(),
                                                   sCompleteFileName)) {
        sCompleteFileName = CGRuntime::canonizePath(sCompleteFileName);
        hModule = LoadLibrary(sCompleteFileName.c_str());
      }
      if (hModule == NULL)
        throw UtlException("unable to load library '" + sLibraryWithExt + "'");
    }
  }
  hHandle = hModule;
#else
...
void
DynPackage::freeLibrary(LIBRARY_HANDLE hHandle)
{
#ifdef WIN32
...
void*
DynPackage::findFunction(LIBRARY_HANDLE hHandle, const std::string& sFunction)
{
#ifdef WIN32
