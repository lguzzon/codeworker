...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pIndexExpr == NULL) {
            throw UtlException("'first(" + pIndexParam->getName() + ")' has no sense: '" + pIndexParam->getName() + "' isn't declared as an index");
        }

        DtaArrayIterator* pIteratorData = pIndexExpr->getIteratorData();

        if (pIteratorData == NULL) {
            throw UtlException("'first(" + pIndexParam->getName() + ")' can't work here: '" + pIndexParam->getName() + "' is a reference to an index\nif '" + pIndexParam->getName() + "' is a function parameter, write '" + pIndexParam->getName() + " : index' in the prototype");
        }
...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pIndexExpr == NULL) {
            throw UtlException("'last(" + pIndexParam->getName() + ")' has no sense: '" + pIndexParam->getName() + "' isn't declared as an index");
        }

        DtaArrayIterator* pIteratorData = pIndexExpr->getIteratorData();

        if (pIteratorData == NULL) {
            throw UtlException("'last(" + pIndexParam->getName() + ")' can't work here: '" + pIndexParam->getName() + "' is a reference to an index\nif '" + pIndexParam->getName() + "' is a function parameter, write '" + pIndexParam->getName() + " : index' in the prototype");
        }
...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pIndexExpr == NULL) {
            throw UtlException("'key(" + pIndexParam->getName() + ")' has no sense: '" + pIndexParam->getName() + "' isn't declared as an index");
        }

        DtaArrayIterator* pIteratorData = pIndexExpr->getIteratorData();

        if (pIteratorData == NULL) {
            throw UtlException("'key(" + pIndexParam->getName() + ")' can't work here: '" + pIndexParam->getName() + "' is a reference to an index\nif '" + pIndexParam->getName() + "' is a function parameter, write '" + pIndexParam->getName() + " : index' in the prototype");
        }
...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pIndexExpr == NULL) {
            throw UtlException("'index(" + pIndexParam->getName() + ")' has no sense: '" + pIndexParam->getName() + "' isn't declared as an iterator");
        }

        DtaArrayIterator* pIteratorData = pIndexExpr->getIteratorData();

        if (pIteratorData == NULL) {
            throw UtlException("'index(" + pIndexParam->getName() + ")' can't work here: '" + pIndexParam->getName() + "' is a reference to an iterator\nif '" + pIndexParam->getName() + "' is a function parameter, write '" + pIndexParam->getName() + " : index' in the prototype");
        }
...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pIndexExpr == NULL) {
            throw UtlException("'prec(" + pIndexParam->getName() + ")' has no sense: '" + pIndexParam->getName() + "' isn't declared as an iterator");
        }

        DtaArrayIterator* pIteratorData = pIndexExpr->getIteratorData();

        if (pIteratorData == NULL) {
            throw UtlException("'prec(" + pIndexParam->getName() + ")' can't work here: '" + pIndexParam->getName() + "' is a reference to an iterator\nif '" + pIndexParam->getName() + "' is a function parameter, write '" + pIndexParam->getName() + " : Prec' in the prototype");
        }
...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pIndexExpr == NULL) {
            throw UtlException("'next(" + pIndexParam->getName() + ")' has no sense: '" + pIndexParam->getName() + "' isn't declared as an iterator");
        }

        DtaArrayIterator* pIteratorData = pIndexExpr->getIteratorData();

        if (pIteratorData == NULL) {
            throw UtlException("'next(" + pIndexParam->getName() + ")' can't work here: '" + pIndexParam->getName() + "' is a reference to an iterator\nif '" + pIndexParam->getName() + "' is a function parameter, write '" + pIndexParam->getName() + " : Next' in the prototype");
        }
...
public:
    ...
    virtual const char* getName() const
    {
        return "addGenerationTagsHandler";
    }
    virtual unsigned int getArity() const
    {
        return 3;
...
public:
    ...
    virtual const char* getName() const
    {
        return "createVirtualTemporaryFile";
    }
    virtual unsigned int getArity() const
    {
        return 1;
...
public:
    ...
    virtual std::string getValue(DtaScriptVariable& visibility) const
    {
        ...
        if (pOldIt == NULL) {
            pOldIt = visibility.getVariable(*dynamic_cast<ExprScriptVariable*>(*cursor));
        }
...
public:
    ...
    virtual const char* getName() const
    {
        return "extractGenerationHeader";
    }
    virtual unsigned int getArity() const
    {
        return 4;
...
public:
    ...
    virtual const char* getName() const
    {
        return "findFirstSubstringIntoKeys";
    }
    virtual unsigned int getArity() const
    {
        return 2;
...
public:
    ...
    virtual const char* getName() const
    {
        return "findNextSubstringIntoKeys";
    }
    virtual unsigned int getArity() const
    {
        return 3;
...
public:
    ...
    virtual const char* getName() const
    {
        return "receiveBinaryFromSocket";
    }
    virtual unsigned int getArity() const
    {
        return 2;
...
public:
    ...
    virtual const char* getName() const
    {
        return "removeGenerationTagsHandler";
    }
    virtual unsigned int getArity() const
    {
        return 1;
...
public:
    ...
    virtual const char* getName() const
    {
        return "selectGenerationTagsHandler";
    }
    virtual unsigned int getArity() const
    {
        return 1;
...
public:
    ...
    virtual bool isAParseFunction() const
    {
        return true;
    }
...
public:
    ...
    virtual const char* getName() const
    {
        return "readIfEqualToIgnoreCase";
    }
    virtual unsigned int getArity() const
    {
        return 1;
...
public:
    ...
    virtual const char* getName() const
    {
        return "readIfEqualToIdentifier";
    }
    virtual unsigned int getArity() const
    {
        return 1;
...
public:
    ...
    virtual const char* getName() const
    {
        return "skipEmptyCppExceptDoxygen";
    }
    virtual unsigned int getArity() const
    {
        return 0;
...
public:
    ...
    virtual const char* getName() const
    {
        return "remainingProtectedAreas";
    }
    virtual unsigned int getArity() const
    {
        return 1;
...
{
    for (std::vector<ExprScriptExpression*>::iterator i = _parameters.begin(); i != _parameters.end(); i++) {
        delete (*i);
    }
...
int ExprScriptFunction::getThisPosition() const
{
    return 0;
}
...
std::string ExprScriptFunction::getValue(DtaScriptVariable& visibility) const
{
    ...
    if (_pPrototype == NULL) {
        throw UtlException("ExprScriptFunction::getValue() -> must be implemented into derivated classes\nFor custom functions, see class GrfFunction");
    }
...
ExprScriptFunction* ExprScriptFunction::create(GrfBlock& block, ScpStream& script, const std::string& sFunction, const std::string& sTemplate, bool bGenericKey)
{
    ...
    if (getFunctionRegister().find(sFunctionName) != getFunctionRegister().end()) {
        if (!sTemplate.empty()) {
            throw UtlException("predefined function '" + sFunction + "' cannot instantiate template function '" + sFunction + "<" + sTemplate + ">'");
        }
...
EXPRESSION_RETURN_TYPE ExprScriptFunction::compileCpp(CppCompilerEnvironment& theCompilerEnvironment) const
{
    ...
    for (std::vector<ExprScriptExpression*>::const_iterator i = _parameters.begin(); i != _parameters.end(); i++) {
        ...
        if ((getParameterType(iIndex) & 0x00FF) == VALUE_EXPRTYPE) {
            ...
            dynamic_cast<ExprScriptVariable*>(*i)->compileCppForSet(theCompilerEnvironment);
        }
