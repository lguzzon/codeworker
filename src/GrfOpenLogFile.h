...
#ifndef _GrfOpenLogFile_h_
#define _GrfOpenLogFile_h_
...
class GrfOpenLogFile : public GrfCommand
{
private:
...
public:
  GrfOpenLogFile()
    : _pFilename(NULL)
  {}
  virtual ~GrfOpenLogFile();

  virtual const char* getFunctionName() const { return "openLogFile"; }
