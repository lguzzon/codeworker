...
#ifndef _BNFDisjunction_h_
#define _BNFDisjunction_h_
...
class BNFDisjunction : public GrfBlock
{
private:
    DtaBNFScript* _pBNFScript;

public:
    BNFDisjunction(DtaBNFScript* pBNFScript, GrfBlock* pParent);
    virtual ~BNFDisjunction();
