...
public:
  DtaFollowingAttributeInfo(DtaAttributeType* pType)
    : _iNumberOfUse(0)
    , _pAttributeType(pType)
  {}
...
public:
  ...
  inline const std::map<std::string, DtaFollowingAttributeInfo*>&
  getAttributes() const
  {
    return _mapOfAttributes;
  }
  inline const std::map<std::string, DtaFollowingAttributeInfo*>&
  getAttributeElements() const
  {
