...
DtaScriptFactory::SCRIPT_TYPE DtaDesignScript::getType() const
{
    return DtaScriptFactory::FREE_SCRIPT;
}
bool DtaDesignScript::isAParseScript() const
{
    return true;
}
...
void DtaDesignScript::traceEngine() const
{
    if (getFilenamePtr() == NULL) {
        ...
        CGRuntime::traceLine("free-parsing script \"" + std::string(getFilenamePtr()) + "\":");
    }
