...
public class CompiledTranslationScript {
	@SuppressWarnings("unused")
	private byte[] cppInstance_;
	
	public CompiledTranslationScript() { cppInstance_ = init(); }
	...
	public native void translate(ParseTree pContext, String sInputFile, String sOutputFile);
	public native String translateString(ParseTree pContext, String sInputText);
